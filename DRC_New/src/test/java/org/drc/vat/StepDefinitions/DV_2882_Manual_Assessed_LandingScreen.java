...
public class DV_2882_Manual_Assessed_LandingScreen 
{
	...
	@Given("^User click on windoews icon$")
	...
	public void user_click_on_manage_setting_drop_down_and_check_drop_down_list_for_Reassign_and_Assess() throws Throwable 
	{
		Thread.sleep(1000);
	...
	public void user_click_on_FilterBy_dropdown_and_click_on_Status(String filterby) throws Throwable 
	{
	  ...
	  clickOn(filterby, "");
	  Thread.sleep(500);
	  clickOn("txt_AssestFilterBusinessType", "");	   
	  Thread.sleep(500);
	  clickOn(filterby, "");
	  Thread.sleep(500);
	  clickOn("txt_AssestFilterStatus", "");
	...
	public void user_click_on_search_button_and_check_status(String checkStatus) throws Throwable 
	{
		...
		if(wd.findElement(By.xpath("(//span[contains(text(),'" + checkStatus + "')])[2]")).isDisplayed() )
		{		
	...
	public void user_click_on_Previous_button_on_Operations_Performed_page() throws Throwable 
	{
		 ...
		 String Manual_Asseessment_NITVA= wd.findElement(By.xpath(obj.getProperty("txt_NITVA_Status_Changed"))).getText();
	...
	public void user_enter_again_data_and_check_message_no_record_found(String arg1) throws Throwable
	{
	...
	public void user_filter_record_again_and_click_on_business_type_and_user_click_on(String value1, String value2, String value3) throws Throwable 
	{
		Thread.sleep(500);
		clickOn(value1, "");
		Thread.sleep(1000);
	...
	/*@And("^User select \"([^\"]*)\"$")
	public void user_select(String month) throws Throwable 
	{
	  clickOn("", "");
	  Thread.sleep(1000);
	  clickOn(month, "");
