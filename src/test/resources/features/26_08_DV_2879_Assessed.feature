Feature: User is on Assessed List on Adjustment Page
  ...
  Scenario Outline: Validate the NITVA field,Period field
    ...
    Examples: 
      ...
      | Ass_Adj_02_03 | validate nitva no,Period field | txt_PeriodFeb | Regression MarchMons| txt_2019_Period |
  ...
  Scenario Outline: validate Total additional liability tile on adjustment,Total Assessed tile,Edit button functionality
    ...
    Examples: 
      ...
      | Ass_Adj_06_07_08_09_10 | validate view icon in transaction received table and Total of Difference field | txt_PeriodFeb | txt_2019_Period | Regression MarchMons|  0 |  0 |  5 |  5 | Saved Successfully |   10 |   10 |   10 |   10 | This field is required |
  ...
  Scenario Outline: Validate the view icon in transaction received table and Total of Difference field under Amount column internal portal
    ...
    Examples: 
      | TestcaseID    | Description                                                                    | Period        | TaxPayer           | Year            |
      | Ass_Adj_13_14 | validate view icon in transaction received table and Total of Difference field | txt_PeriodFeb | Regression MarchMons| txt_2019_Period |
...
#
    #Examples: 
      ...
      #| Ass_Adj_16_17_18_19_21 | validate view icon in transaction received table and Total of Difference field | txt_PeriodFeb | Regression MarchMons| File not found | txt_2019_Period |
  ...
  Scenario Outline: Validate the e-filing schedule button functionality when e-file schedule file is uploaded by tax payer from tax payer portal
    ...
    Examples: 
      | TestcaseID | Description                                                        | Period        | TaxPayer           | Year            |
      | Ass_Adj_20 | validate download functionality when user upload file on tax payer | txt_PeriodFeb | Regression MarchMons| txt_2019_Period |
  ...
  Scenario Outline: Validate Negative Scenario for all fields
    ...
    Examples: 
      ...
      | Ass_Adj_1  | Validate length of number | txt_PeriodFeb | Regression MarchMons| 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | txt_2019_Period |
  ...
  Scenario Outline: Validate Negative Scenario for all fields
    ...
    Examples: 
      | TestcaseID | Description                 | Period        | TaxPayer           |   17 |   18 |   19 |   20 | Year            |
      | Ass_Adj_1  | Validate special chatracter | txt_PeriodFeb | Regression MarchMons| @!@$ | @!@$ | @!@$ | @!@$ | txt_2019_Period |
      | Ass_Adj_2  | Validate alpha numeric      | txt_PeriodFeb | Regression MarchMons| A12  | B465 | C465 | D234 | txt_2019_Period |
