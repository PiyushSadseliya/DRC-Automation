Feature: User is on Assessment Summary Manual Assessement
  ...
  Scenario Outline: Validate that the Assessment Summary tab record should get saved successfully through Save and Next button operation 
    ...
    Examples: 
      ...
      | Mal_AS_07  | validate Happy Path | txt_PeriodFeb | regressionforty |  1101 | 1101 | 1101  | 1101| Saved Successfully | Verified through EFD transactions | Select remarks | Verified through EFD transactions | txt_2019_Period |
  ...
  Scenario Outline: Validate the Prev button functionality
    ...
    Examples: 
      | TestcaseID                  | Description                 | Period        | TaxPayer         |  1     | 10    | 10.1  | 17    | SaveMess           | selectedRemark                    | SR             | selected                          | Year            |
      | Mal_AS_14_08_09_10_11_12_13 | validate prev functionality | txt_PeriodFeb | regressionforty | 110101 | 10101 | 10101 | 1010  | Saved Successfully | Verified through EFD transactions | Select remarks | Verified through EFD transactions | txt_2019_Period |
  ...
  Scenario Outline: Validate the Previous button functionality
    ...
    Examples: 
      | TestcaseID | Description                     | Period        | TaxPayer         |  1    | 10    | 10.1  | 17   | SaveMess           | selectedRemark                    | SR             | selected                          | Year            |
      | Mal_AS_15  | validate previous functionality | txt_PeriodFeb | regressionforty | 10101 | 10101 | 10101 | 1010 | Saved Successfully | Verified through EFD transactions | Select remarks | Verified through EFD transactions | txt_2019_Period |
  ...
  Scenario Outline: Validate e-filing schedule button functionality when tax payer uploaded file at the time of e-declaration.
    ...
    Examples: 
      | TestcaseID | Description                                                       | Period        | TaxPayer         | Year            |
      | Mal_AS_17  | validate download functionality when user upload file on tax paye | txt_PeriodFeb | regressionforty | txt_2019_Period |
  ...
  Scenario Outline: Validate that the Total Additional Liability(FC) amount should be zero when Total e-Declaration(FC)  amount should  be same as Total Assessed(FC) amount.
    ...
    Examples: 
      | TestcaseID | Description    | Period        | TaxPayer         | Year            |
      | Mal_AS_24  | amount is same | txt_PeriodFeb | regressionforty | txt_2019_Period |
  ...
  Scenario Outline: Validate that the Total Additional Liability(FC) amount should be more than zero when Total e-Declaration(FC)  amount is less than Total Assessed(FC) amount
    ...
    Examples: 
      ...
      | Mal_AS_25_26 | validate additionality liablility with more than zero and less than zero | txt_PeriodFeb | regressionforty | Saved Successfully | 500000 |  1 |    0 | 10 |    400 |       5 |         5 |      10 | txt_2019_Period |
  ...
  Scenario Outline: Validate that the Assessment Summary tab records should get auto populated with only those records whose changes made in assessment adjustment table for Operations Performed, Tax Deductible and Adjustment tab 
    ...
    Examples: 
      ...
      | Mal_AS_27  | validate tabs auto populated in assessment adjustement | txt_PeriodFeb | regressionforty | 1500 |  15 |    15 | 110 | txt_2019_Period |
