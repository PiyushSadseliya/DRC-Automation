...
Feature: Tax Bill Payment   | NetBanking and Over the counter
  ...
  Scenario Outline: Vaildate the Tax Bill Payment for particular month done by Over the counter
    ...
    Examples: 
      ...
      | DRC_ATC_TaxBillPayment_01 | Vaildate the Tax Bill Payment for particular month done by Over the counter | 12345@sharklasers.com | abcde@12345 | 26-Sep-2018 | January | 20180926012113710 | 12345@sharklasers.com | 340653459035 | Smit tran | Add | Jan-2018 |       800 |        0 |       0 |     0 |   800 | Eight Hundred Franc Congolais Only. | DGI      | 18042600001632 | Central Bank Of Drc | RBISOGSTPMT |    800 | 20-02-2018 |
  ...
  Scenario Outline: Vaildate the Tax Bill Payment when user pays from Total Liability Pay button
    ...
    Then Verifies the liability details records"1" Period"<period1>"VAT"<vatamount1>"Interest"<interest1>"Penalty"<penalty1>"LateFee"<ltfee1>"TotalAmount"<total1>"
