 ...
 #   Then Click on View in Manage Options
  ...
  Scenario Outline: Validate the collection officer sent the notification to taxpayer for Escalates the case to legal.
    ...
    Examples: 
      ...
      | DRC_ATC_AssignedDebt_Notification_03 | Validate the System  sent the notification to tax payer for Full payment not made till the deadline | Ketan       | ketan.prajapati | admin    | 0-3 Months | amount | R18112900000003 | 2018-09-19 | 2018-09-21 | Jainik            |
