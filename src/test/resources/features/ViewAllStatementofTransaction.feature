...
Feature: To view all the Transaction done by the VAT User
  ...
  Scenario Outline: Validate the functionality of View button located on the statement of transaction section of e-filing landing page
    ...
    Examples: 
      ...
      | DRC_ATC_Efiling_01 | Validate the functionality of View button located on the statement of transaction section of e-filing landing page | test06@sharklasers.com | abcde@12345 |
  ...
  Scenario Outline: Validate the effect on Statement of Transaction table columns data when the e-filing is done particular month and Payment is not done
    ...
    Examples: 
      ...
      | DRC_ATC_Efiling_02 | Validate the effect on Statement of Transaction table columns data when the e-filing is particular month and Payment is not done | 12345@sharklasers.com | abcde@12345 | 06-Oct-2018 | January |      5000 |  2018 | e-Filing     |            0 |        800 |      0 |         0 |        0 |    800 |
  ...
  Scenario Outline: Validate the effect on Statement of Transaction table columns data when the e-filing is done and payment not done
    ...
    Examples: 
      ...
      | DRC_ATC_Efiling_03 | Validate the effect on Statement of Transaction table columns data when the e-filing is done and payment is done(Offset Efiling) | test04@sharklasers.com | abcde@12345 | February |  2018 |         0 | 06-Oct-2018 | January |  2018 | e-Filing     |            0 |        800 |      0 |         0 |        0 |    800 | 06-Oct-2018 | e-Filing     |          800 |          0 |      0 |         0 |        0 |    800 |
  ...
  Scenario Outline: Validate the effect on Statement of Transaction table columns data when the e-filing  is done and Payment is done more than the vat liability of previous months
    ...
    Examples: 
      | Test Case ID       | Description                                                                                                                                                      | uname                  | password    | period3 | year3 | taxamount | date1       | period1 | year1 | particulars1 | OpenBalance1 | vatamount1 | ltfee1 | interest1 | penalty1 | total1 | date2       | period2  | year2 | particulars2 | OpenBalance2 | vatamount2 | ltfee2 | interest2 | penalty1 | total2 | date3       | particulars3 | OpenBalance3 | vatamout3 | ltfee3 | interest3 | penalty3 | total3 | date2       | period2 | year2 | particulars2 | OpenBalance2 | vatamount2 | ltfee2 | interest2 | penalty1 | total2 |
      | DRC_ATC_Efiling_04 | Validate the effect on Statement of Transaction table columns data when the e-filing  is done and Payment is done more than the vat liability of previous months | test04@sharklasers.com | abcde@12345 | March   |  2018 |      5000 | 06-Oct-2018 | January |  2018 | e-Filing     |            0 |        800 |      0 |         0 |        0 |    800 | 06-Oct-2018 | February |  2018 | e-Filing     |          800 |          0 |      0 |         0 |        0 |    800 | 05-Oct-2018 | e-Filing     |          800 |       800 |      0 |         0 |        0 |  1.600 | 06-Oct-2018 | -       |       | Payment      |        1.600 |     -1.700 |      0 |         0 |        0 |   -100 |
  ...
  Scenario Outline: Validate the effect on Statement of Transaction table columns data when the e-filing is done particular month and Payment is done
    ...
    Examples: 
      | Test Case ID       | Description                                                                                                       | uname                   | password    | period4 | year4 | taxamount | date1 | period1 | year1 | particulars1 | OpenBalance1 | vatamount1 | ltfee1 | interest1 | penalty1 | total1 | date2 | period2  | year2 | particulars2 | OpenBalance2 | vatamount2 | ltfee2 | interest2 | penalty1 | total2 | date3       | period3 | year3 | particulars3 | OpenBalance3 | vatamount3 | ltfee3 | interest3 | penalty3 | total3 | date4       | particulars4 | OpenBalance4 | vatamount4 | ltfee4 | interest4 | penalty4 | total4 |
      | DRC_ATC_Efiling_05 | Validate the effect on Statement of Transaction table columns data when the e-filing  is done and Payment is done | execute@sharklasers.com | abcde@12345 | April   |  2018 |      5000 |       | January |  2018 | e-Filing     |            0 |        800 |      0 |         0 |        0 |    800 | date1 | February |  2018 | e-Filing     |          800 |          0 |      0 |         0 |        0 |    800 | 05-Oct-2018 | March   |  2018 | e-filing     |          800 |        800 |      0 |         0 |        0 |    800 | 05-Oct-2018 | e-Filing     |          800 |        800 |      0 |         0 |        0 |  1.600 |
  ...
  Scenario Outline: Validate the effect on Statement of Transaction table columns data when the e-filing is done particular month and Payment is not done
    ...
    Examples: 
      | Test Case ID       | Description                                                                                                                      | uname                   | password    | period5 | year5 | taxamount | date1       | period1 | year1 | particulars1 | OpenBalance1 | vatamount1 | ltfee1 | interest1 | penalty1 | total1 | date2       | period2  | year2 | particulars2 | OpenBalance2 | vatamount2 | ltfee2 | interest2 | penalty1 | total2 | date3       | particulars3 | OpenBalance3 | vatamout3 | ltfee3 | interest3 | penalty3 | total3 | date4       | particulars4 | period4 | year4 | OpenBalance4 | vatamount4 | ltfee4 | interest4 | penalty4 | total4 | date5       | particulars5 | OpenBalance5 | vatamount5 | ltfee5 | interest5 | penalty5 | total5 |
      | DRC_ATC_Efiling_06 | Validate the effect on Statement of Transaction table columns data when the e-filing is particular month and Payment is not done | execute@sharklasers.com | abcde@12345 | May     |  2018 |      5000 | 05-Oct-2018 | January |  2018 | e-Filing     |            0 |        800 |      0 |         0 |        0 |    800 | 05-Oct-2018 | February |  2018 | e-Filing     |          800 |          0 |      0 |         0 |        0 |    800 | 05-Oct-2018 | e-Filing     |          800 |       800 |      0 |         0 |        0 |  1.600 | 05-Oct-2018 | e-Filing     | April   |  2018 |        1.600 |        800 |      0 |         0 |        0 |  2.400 | 05-Oct-2018 | e-filing     |        2.400 |        800 |      0 |         0 |        0 |  3.200 |
  ...
  Scenario Outline: Validate the effect on Statement of Transaction table columns data when the e-filing is done and Payment is not done
    ...
    Examples: 
      ...
      | DRC_ATC_Efiling_07 | Validate the effect on Statement of Transaction table columns data when the e-filing is particular month and Payment is not done | execute@sharklasers.com | abcde@12345 | 05-Oct-2018 | June    |      5000 |  2018 | 05-Oct-2018 | e-Filing |            0 |            0 |        800 |      0 |         0 |        0 |    800 | 05-Oct-2018 | February |  2018 | e-filing     |          800 |          0 |      0 |         0 |        0 |    800 | 05-Oct-2018 | March   |  2018 | e-Filing     |          800 |        800 |      0 |         0 |        0 |  1.600 | 05-Oct-2018 | April   |  2018 | e-Filing     |        1.600 |        800 |      0 |         0 |        0 |  2.400 | 05-Oct-2018 | May     |  2018 | E-filing     |        2.400 |        800 |      0 |         0 |        0 |  3.200 | 05-Oct-2018 | E-filing      |        3.200 |        800 |      0 |         0 |        0 |  4.000 |
