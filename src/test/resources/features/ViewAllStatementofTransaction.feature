...
Feature: To view all the Transaction done by the VAT User
  ...
  Scenario Outline: Validate the functionality of View button located on the statement of transaction section of e-filing landing page
    ...
    Examples: 
      ...
      | DRC_ATC_Efiling_01 | Validate the functionality of View button located on the statement of transaction section of e-filing landing page | refac@mailinator.com | Test@123 |
  ...
  Scenario Outline: Validate the effect on Statement of Transaction table columns data when the e-filing is done particular month and Payment is not done
    ...
    Examples: 
      ...
      | DRC_ATC_Efiling_02 | Validate the effect on Statement of Transaction table columns data when the e-filing is particular month and Payment is not done | refac@mailinator.com | Test@123 | 27-Nov-2018 | January |   5000,00 |  2018 | e-Filing     |         0,00 |     800,00 |   0,00 |      0,00 |     0,00 | 800,00 |
  ...
  Scenario Outline: Validate the effect on Statement of Transaction table columns data when the e-filing is done and payment not done
    ...
    Examples: 
      ...
      | DRC_ATC_Efiling_03 | Validate the effect on Statement of Transaction table columns data when the e-filing is done and payment is done(Offset Efiling) | refac@mailinator.com | Test@123 | February |  2018 |      0,00 | 27-Nov-2018 | January |  2018 | e-Filing     |         0,00 |     800,00 |   0,00 |      0,00 |     0,00 | 800,00 | 27-Nov-2018 | e-Filing     |       800,00 |       0,00 |   0,00 |      0,00 |     0,00 | 800,00 |
  ...
  Scenario Outline: Validate the effect on Statement of Transaction table columns data when the e-filing  is done and Payment is done more than the vat liability of previous months
    ...
    Examples: 
      ...
      | DRC_ATC_Efiling_04 | Validate the effect on Statement of Transaction table columns data when the e-filing  is done and Payment is done more than the vat liability of previous months | refac@mailinator.com | Test@123 | March   |  2018 |   5000,00 | 27-Nov-2018 | January |  2018 | e-Filing     |         0,00 |     800,00 |   0,00 |      0,00 |     0,00 | 800,00 | 27-Nov-2018 | February |  2018 | e-Filing     |       800,00 |       0,00 |   0,00 |      0,00 |     0,00 | 800,00 | 27-Nov-2018 | e-Filing     |       800,00 |    800,00 |   0,00 |      0,00 |     0,00 |  1.600 | 27-Nov-2018 | -       |       | Payment      |        1.600 |     -1.700 |   0,00 |      0,00 |     0,00 | -100,00 |
  ...
  Scenario Outline: Validate the effect on Statement of Transaction table columns data when the e-filing is done particular month and Payment is done
   ...
   # Then user Declares for "<period4>""<year4>""<taxamount>"
    ...
    Examples: 
      ...
      | DRC_ATC_Efiling_05 | Validate the effect on Statement of Transaction table columns data when the e-filing  is done and Payment is done | refac@mailinator.com | Test@123 | April   |  2018 |      5000 |       | January |  2018 | e-Filing     |      0,00 |        800 | 0,00,00 |   0,00, |  0,00|    800 | date1 | February |  2018 | e-Filing     |          800 |    0,00,00 | 0,00 |   0,00 |  0,00 |    800 | 27-Nov-2018 | March   |  2018 | e-filing     |          800 |        800 |   0,00 |      0,00 |     0,00 |    800 | 27-Nov-2018 | e-Filing     |          800 |        800 |   0,00 |      0,00 |     0,00 |  1.600 |
  ...
  Scenario Outline: Validate the effect on Statement of Transaction table columns data when the e-filing is done particular month and Payment is not done
    ...
    Examples: 
      ...
      | DRC_ATC_Efiling_06 | Validate the effect on Statement of Transaction table columns data when the e-filing is particular month and Payment is not done | refac@mailinator.com | Test@123 | May     |  2018 |      5000 | 27-Nov-2018 | January |  2018 | e-Filing     |         0,00 |        800 |   0,00 |      0,00 |     0,00 |    800 | 27-Nov-2018 | February |  2018 | e-Filing     |          800 |       0,00 |   0,00 |      0,00 |     0,00 |    800 | 27-Nov-2018 | e-Filing     |          800 |       800 |   0,00 |      0,00 |     0,00 |  1.600 | 27-Nov-2018 | e-Filing     | April   |  2018 |        1.600 |        800 |   0,00 |      0,00 |     0,00 |  2.400 | 27-Nov-2018 | e-filing     |        2.400 |        800 |   0,00 |      0,00 |     0,00 |  3.200 |
