...
#in working for tc 01 to staus for extrem page and refresh and filter for first page
#@FilterTest
...
#And go to last page and it should display revelant data 
#And filter the record on first page "<first>"
#And filter the record on first page and check "<check>" 
#And check the data from first page "<check>"

#Examples:
#| TestcaseID                   | Filters                   |Value|check|
#|Valid_Manage_VAT_Reg_Filter_01| Priority                  |11   |Test 222|
#|Valid_Manage_VAT_Reg_Filter_02| NIF                      |JUIJIBI121213|
#|Valid_Manage_VAT_Reg_Filter_03| Name of Business/Applicant|Arun|
#|Valid_Manage_VAT_Reg_Filter_04| Taxpayer Sub Category     |Individual|
...
Examples:
| TestcaseID                     |Filters|Value|
|Valid_Manage_VAT_Reg_RejPopUp_01|Status |OnHold|
...
|Valid_Manage_VAT_Reg_Sort_01|desc|10|
