Feature: User is on Payment Agreement Landing Screen (Tax-officer)
   ...
   @TC_01_UI_Payment_Agreement
  Scenario Outline: Validate the UI of Payment Agreement Landing Screen.
    ...
    Examples: 
      | TestcaseID                      | Description               | filter           | button              | id              |
      | Payment_Agrement_Tax_Officer_01 | Verify the UI of the Page | drp_CaseID_Click | drp_PaymentAgrement | R18092000000004 |
  ...
  Scenario Outline: Validate the Browse button functionality
    ...
    And User again click on browse and select file and user see message "<message>"

    Examples: 
      | TestcaseID                      | Description               | filter           | id              | message                         |
      | Payment_Agrement_Tax_Officer_21 | Verify the UI of the Page | drp_CaseID_Click | R18092000000004 | Only 1 document can be uploaded |
 ...
 @TC_26_Date
  ...
  Scenario Outline: Validate the Browse button functionality
    ...
    Examples: 
      | TestcaseID                      | Description          | filter           | id              |message                         |
      | Payment_Agrement_Tax_Officer_45 | Verify browse button | drp_CaseID_Click |R18092400000001  |Only 1 document can be uploaded |
  ...
  # @TC_47 @Submit_button coved in 02 scenario
