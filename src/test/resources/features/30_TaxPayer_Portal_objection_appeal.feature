...
#
  ...
  Scenario Outline: Validate title ,period and object type
    ...
    Examples: 
      ...
      | Objection_Appeal_Tax_Payer_16_18_19 | Verify raise notice for objection | regressionlast@mailinator.com | Test@123 | eJan  | btn_Jan_View | drp_Objection_Assesment | Notice raised |Assessment | Title field is required. | abc  | objection is incorrect |
