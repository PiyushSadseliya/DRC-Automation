Feature: User is on Tax Deductible Page Manual Assessement
  ...
  Scenario Outline: Validate the NITVA field,Period field
    ...
    Examples: 
      ...
      | Tax_Dec_02_03 | validate nitva no,Period field | txt_PeriodFeb | Regression AprilTOne | txt_2019_Period |
  ...
  Scenario Outline: Validate amount in Total Additional liability tile.
    ...
    Examples: 
      ...
      | Tax_Dec_06_05 | validate nitva no,Period field | txt_PeriodFeb | Regression AprilTOne | 500 |  500 | 500 |  500 | 500 |  500 | 500 |  500 | txt_2019_Period |
  ...
  Scenario Outline: Validate the Edit button functionality , Save button functionality ,next button functionality when assessment officer edit
    ...
    Examples: 
      ...
      | Tax_Dec_07_19_17 | validate Edit button functionality and Total of Difference field and Save button functionality | txt_PeriodFeb | Regression AprilTOne |  5 |    5 |  0 |    0 |  0 |    0 |  0 |    0 | Saved Successfully | txt_2019_Period |
  ...
  Scenario Outline: Validate the view icon in transaction received table and Total of Difference field.
    ...
    Examples: 
      | TestcaseID    | Description                                                                    | Period        | TaxPayer               | Year            |
      | Tax_Dec_10_11 | validate view icon in transaction received table and Total of Difference field | txt_PeriodFeb | Regression AprilTOne | txt_2019_Period |
  ...
  Scenario Outline: Validate the download functionality of e-filing schedule button when e-file schedule file is uploaded by tax payer from tax payer portal
    ...
    Examples: 
      | TestcaseID | Description                                                        | Period        | TaxPayer               | Year            |
      | Tax_Dec_14 | validate download functionality when user upload file on tax payer | txt_PeriodFeb | Regression AprilTOne | txt_2019_Period |
  ...
  Scenario Outline: Validate the download functionality of Transaction Received button and e-filing schedule button when e-file schedule file is not uploaded
    ...
    Examples: 
      ...
      | Tax_Dec_13_15 | validate view icon in transaction received table and Total of Difference field | txt_PeriodJan | Regression AprilTOne | File not found | txt_2019_Period |
  ...
  Scenario Outline: Validate the next button functionality when assessment officer does not edit the fields on the page
    ...
    Examples: 
      | TestcaseID       | Description                                                                    | Period        | TaxPayer               | Year            |
      | Tax_Dec_16_18_20 | validate view icon in transaction received table and Total of Difference field | txt_PeriodFeb | Regression AprilTOne | txt_2019_Period |
  ...
  Scenario Outline: Validate Negative Scenario for all fields
    ...
    Examples: 
      | TestcaseID | Description                 | Period        | TaxPayer               |   10 | 10.1 |   11 | 11.1 |   12 | 12.1 |   13 | 13.1 | Year            |
      | Tax_Dec_1  | Validate special chatracter | txt_PeriodFeb | Regression AprilTOne | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | txt_2019_Period |
      | Tax_Dec_2  | Validate alpha numeric      | txt_PeriodFeb | Regression AprilTOne | A12  | B123 | C465 | D234 | E234 | F123 | G123 | H123 | txt_2019_Period |
  ...
  Scenario Outline: Validate Negative Scenario for all fields length
    ...
    Examples: 
      ...
      | Mal_OP_NS_Field_Length_1 | Validate length of number | txt_PeriodFeb | txt_2019_Period | Regression AprilTOne | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 |
