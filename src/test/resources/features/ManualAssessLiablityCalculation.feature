...
Feature: I want to calculate the user liability after the manaul assessment
  ...
  Scenario Outline: The officer want to validate the additional liability
            Given The tax payer has done E-Filing for the particular month"<Test Case ID>""<Description>"
    And The Assessed VAT on "<type>" must be prepopulated and should be "<compare>" than e-Declaration VAT on Sales
    When The taxofficer has logged in internal portal
    And the officer is on liability calculation for the particular period"<month>""<year>""<nitvano>"
    And the e-declartion data must be same as efiling with"<EVATonSales>""<EVATonPurchase>""<EUtilisedCredit>""<ElateFee>""<EInterest>""<EPenalty>"
    And The Assessed data must be same as from EFD"<AVATonSales>""<AVATonPurchase>""<AUtilisedCredit>""<AlateFee>""<AInterest>""<APenalty>""<ATotal>"
    Then The Additional liability must be Assessed minus e-Declaration"<LVATonSales>""<LVATonPurchase>""<LUtilisedCredit>""<LlateFee>""<LInterest>""<LPenalty>""<LTotal>"
    ...
    Examples: 
      ...
      | DRC_ATC_ManualAssessmentLiability_02 | validate the additional liability when Assessed is greater than e-Declaration in VAT on Sales    | Sales    | greater | month | year | nitvano |             |                |                 |          |           |          |        |             |                |                 |          |           |          |        |             |                |                 |          |           |          |        |
      | DRC_ATC_ManualAssessmentLiability_03 | validate the additional liability when Assessed is greater than e-Declaration in VAT on Purchase | Purchase | greater | month | year | nitvano |             |                |                 |          |           |          |        |             |                |                 |          |           |          |        |             |                |                 |          |           |          |        |
      | DRC_ATC_ManualAssessmentLiability_04 | validate the additional liability when Assessed is less than e-Declaration in VAT on Sales       | Sales    | less    | month | year | nitvano |             |                |                 |          |           |          |        |             |                |                 |          |           |          |        |             |                |                 |          |           |          |        |
      | DRC_ATC_ManualAssessmentLiability_05 | validate the additional liability when Assessed is less than e-Declaration in VAT on Purchase    | Purchase | less    | month | year | nitvano |             |                |                 |          |           |          |        |             |                |                 |          |           |          |        |             |                |                 |          |           |          |        |
...
And The Assessed data must be same as from EFD"<AVATonSales>""<AVATonPurchase>""<AUtilisedCredit>""<AlateFee>""<AInterest>""<APenalty>""<ATotal>"
  ...
  Scenario Outline: The officer want to validate the Late fee on Manual Assessment page
    ...
    And The Additional liability must be Assessed minus e-Declaration
  ...
  Scenario Outline: The officer want to validate the interest fee on the Manual Assessment Page when the TaxPayer has Paid the VAT Amount in that particulat month itself
    ...
    Examples: 
      ...
      | DRC_ATC_ManualAssessmentLiability_09 | validate the interest fee on the Manual Assessment Page when the TaxPayer has Paid the VAT Amount after the due date  | February | 2018 | 20180705073851634 |     |
      | DRC_ATC_ManualAssessmentLiability_10 | validate the interest fee on the Manual Assessment Page when the TaxPayer has Paid the VAT Amount before the due date | February | 2018 | 20180705073851634 |    0|
  ...
  Scenario Outline: The officer want to validate the interest fee on the Manual Assessment Page when the TaxPayer has Paid the VAT Amount after the Assessment done
    ...
    And Verifies the interest rate calculated
    Examples: 
      | Test Case ID                         | Description                                                                                                                 | Amonth | Ayear | nitvano | 
      | DRC_ATC_ManualAssessmentLiability_11 | validate the interest fee on the Manual Assessment Page when the TaxPayer has Paid the VAT Amount after the Assessment done |     04 |  2018 |         |
  ...
  Scenario Outline: Validate the Interest field on Manual Assessment Page , if user had not done Any paymnet
    ...
    Examples: 
      | Test Case ID                         | Description                                                                                                                              | month | year | nitvano           | interest|
      | DRC_ATC_ManualAssessmentLiability_12 | Validate the Interest field on Manual Assessment Page, if user had not paid the Interest amount for 1 month is not paid                  | July  | 2018 | 20180705073851634 |  0  |
      | DRC_ATC_ManualAssessmentLiability_13 | Validate the Interest field on Manual Assessment Page, if user had not paid the Interest amount for 2 or more than 2 months are not paid | March   | 2018 | 20180630055627898 | 9516190    | 
  ...
  Scenario Outline: The officer want to validate the penalty field in Manual Assessment page
    ...
    Examples: 
      | Test Case ID                         | month | year | nitvano |amount   |
      | DRC_ATC_ManualAssessmentLiability_14 |  March| 2018 |  | |
  ...
  Scenario Outline: Validate the Total of  e-Declaration Amount.
    ...
    When The taxofficer has logged in internal portal
    And the officer is on liability calculation for the particular period"<month>""<year>""<nitvano>"
    Then The e-Declaration total amount must be VAT on Sales-VAT in purchase -Utilised Credit"<EVATonSales>""<EVATonPurchase>""<EUtilisedCredit>""<ElateFee>""<EInterest>""<EPenalty>""<ETotal>"
    ...
    Examples: 
      ...
      | DRC_ATC_ManualAssessmentLiability_15 | Validate E-declaration Total Amount | March | 2018 | 20180705073851634 |		5535				|	10465						|			-70    						|			0	|0					|	0			|	-5000				|
  ...
  Scenario Outline: Validate the Total of  Assessed Amount.
    ...
    Examples: 
      ...
      | DRC_ATC_ManualAssessmentLiability_16 | Validate Assessment Total Amount | April  | 2018 | 20180716054729666 |58049|9844|0|0|1209|0|120|0|49414|
  ...
  Scenario Outline: Validate the Total of Additional Liability
    ...
    Examples: 
      ...
      | DRC_ATC_ManualAssessmentLiability_17 | Validate Total Additional Liablity Amount |  April      | 2018     | 20180716054729666        |56249 | 8992 | 0 |0  |1209  | 0 48446|  |
  ...
  Scenario Outline: Validate amount displaying under e-Declaration column (VAT on Sales, VAT on Purchase, Utilised Credit, Late Fees, Interest and penalty)are as per calculations done on E-Filing.
    ...
    When The taxofficer has logged in internal portal
    And the officer is on liability calculation for the particular period"<month>""<year>""<nitvano>"
    Then Amounts under e-Declaration Column should  pre populated from the e-Declaration done by user"<EVATonSales>""<EVATonPurchase>""<EUtilisedCredit>""<ElateFee>""<EInterest>""<EPenalty>"
  ...
  Scenario Outline: Validate amount displaying under Assessed column (VAT on Sales, VAT on Purchase, Utilised Credit, Late Fees, Interest and penalty)are auto populated based on transaction received in EFD Device.
        Given The tax payer has done E-Filing for the particular month"<Test Case ID>""<Description>"
    And the EFD for VATSales"", VATPurchase, UtilisedCredit, LateFees Interest and penalty has been uploaded
    When The taxofficer has logged in internal portal
    And the officer is on liability calculation for the particular period"<month>""<year>""<nitvano>"
  ...
  Scenario Outline: Validate the editable elements on Liability Calculation page: VAT on Sales, VAT on Purchase, Penalty
    ...
    When The taxofficer has logged in internal portal
    And the officer is on liability calculation for the particular period"<month>""<year>""<nitvano>"
    Then tax office enter "<VAT on Sales>" "<VAT on Purchase>""<Penalty>"
    And click on "Next" button
    And Validation Messages should be shown"<msg>"

    Examples: 
      | Test Case ID                         | Description                         | VAT on Sales                                 | VAT on Purchase                              | Penalty                                      | msg                              |
      | DRC_ATC_ManualAssessmentLiability_22 | Special Characters                  | @!#$!$$$#(&()(&(&&()&()&()&(&(&%%%____++++++ | @!#$!$$$#(&()(&(&&()&()&()&(&(&%%%____++++++ | @!#$!$$$#(&()(&(&&()&()&()&(&(&%%%____++++++ | Only 15 character allowed!       |
      | DRC_ATC_ManualAssessmentLiability_23 | Spaces in between                   | 3443456 345 345                              | 3443456 345 34 5                             | 3443456 345 34 5                             | Only 15 character allowed!       |
      | DRC_ATC_ManualAssessmentLiability_24 |                                     |                                              |                                   3454353453 |                                   3453453453 | Sales Vat amount is required!    |
      | DRC_ATC_ManualAssessmentLiability_25 |                                     |                                     34345543 |                                              |                                   3453453453 | Purchase Vat amount is required! |
      | DRC_ATC_ManualAssessmentLiability_26 |                                     |                                       435345 |                                       456456 |                                              | penalty should not be zero       |
      | DRC_ATC_ManualAssessmentLiability_27 | Negative Amount Should not be shown |                                      -435345 |                                  -3454353453 |                                  -4390765437 |                                  |
      | DRC_ATC_ManualAssessmentLiability_28 |                                     | -                                            | -                                            | -                                            | Enter valid amount!              |
