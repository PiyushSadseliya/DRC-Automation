...
Feature: Upload Documents after all process are completed till the Banks details
  ...
  Scenario Outline: Tax payer Category as  Natural Person and  Tax payer Sub Category as Individual user wants to upload the document
    ...
    Examples: 
      ...
      | DRC_ATC_Valid_Required_doc_01 | Tax payer Category as  Natural Person and  Tax payer Sub Category as Individual user wants to upload the document (.png) | doc_desc1 | Capture.png | doc_desc1 | Capture.png | doc_desc1 | Capture.png | doc_desc1 | Capture.png | doc_desc1_1 | Capture.png | doc_desc1 | Capture.png | regressionnine@mailinator.com | Test@123 |

  #  | DRC_ATC_Valid_Required_doc_02 | Tax payer Category as  Natural Person and  Tax payer Sub Category as Individual user wants to upload the document (.jpg)  | doc_desc1_1 | capture.jpg  | doc_desc3 | capture.jpg  | doc_desc5 | capture.jpg  | doc_desc4 | capture.jpg  | regressionnine@mailinator.com  | Test@123 |
  # | DRC_ATC_Valid_Required_doc_03 | Tax payer Category as  Natural Person and  Tax payer Sub Category as Individual user wants to upload the document (.jpeg)                 | doc_desc1_1 | capture.jpeg       | doc_desc3 | capture.jpeg       | doc_desc5 | capture.jpeg       | doc_desc4 | capture.jpeg       | regressionnine@mailinator.com  | Test@123 |
  # | DRC_ATC_Valid_Required_doc_04 | Tax payer Category as  Natural Person and  Tax payer Sub Category as Individual user wants to upload the document (.pdf)                  | doc_desc1_1 | capture.pdf        | doc_desc3 | capture.pdf        | doc_desc5 | capture.pdf        | doc_desc4 | capture.pdf        | regressionnine@mailinator.com  | Test@123 |
  # | DRC_ATC_Valid_Required_doc_05 | Tax payer Category as  Natural Person and  Tax payer Sub Category as Individual user wants to upload the document (.gif)                  | doc_desc1_1 | capture.gif        | doc_desc3 | capture.gif        | doc_desc5 | capture.gif        | doc_desc4 | capture.gif        | regressionnine@mailinator.com  | Test@123 |
  #| DRC_ATC_Valid_Required_doc_06 | Tax payer Category as  Natural Person and  Tax payer Sub Category as Individual user wants to upload the document (.docx)                 | doc_desc1_1 | capture.docx       | doc_desc3 | capture.docx       | doc_desc5 | capture.docx       | doc_desc4 | capture.docx       | regressionnine@mailinator.com  | Test@123 |
  #| DRC_ATC_Valid_Required_doc_07 | Tax payer Category as  Natural Person and  Tax payer Sub Category as Individual user wants to upload the document (.xlsx) | doc_desc1_1 | capture.xlsx | doc_desc3 | capture.xlsx | doc_desc5 | capture.xlsx | doc_desc4 | capture.xlsx | regressionnine@mailinator.com | Test@123 |
  #| DRC_ATC_Valid_Required_doc_08 | Tax payer Category as  Natural Person and  Tax payer Sub Category as Individual user wants to upload the document (pdf with greater size) | doc_desc1_1 | TCP_Estimation.pdf | doc_desc3 | TCP_Estimation.pdf | doc_desc5 | TCP_Estimation.pdf | doc_desc4 | TCP_Estimation.pdf | regressionnine@mailinator.com  | Test@123 |
  ...
  Scenario Outline: Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document
    ...
    Examples: 
      ...
      #| DRC_ATC_Required_doc_16 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.png  | doc_desc9 | capture.png  | doc_desc6 | capture.png  | doc_desc11 | capture.png  | doc_desc12 | capture.png  | doc_desc10 | capture.png  | regressionnine@mailinator.com  | Test@123 |
      # | DRC_ATC_Required_doc_17 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.jpg  | doc_desc9 | capture.jpg  | doc_desc6 | capture.jpg  | doc_desc11 | capture.jpg  | doc_desc12 | capture.jpg  | doc_desc10 | capture.jpg  | regressionnine@mailinator.com  | Test@123 |
      # | DRC_ATC_Required_doc_18 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.jpeg | doc_desc9 | capture.jpeg | doc_desc6 | capture.jpeg | doc_desc11 | capture.jpeg | doc_desc12 | capture.jpeg | doc_desc10 | capture.jpeg | regressionnine@mailinator.com  | Test@123 |
      | DRC_ATC_Required_doc_19 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.pdf  | doc_desc9 | capture.pdf  | doc_desc6 | capture.pdf  | doc_desc11 | capture.pdf  | doc_desc12 | capture.pdf  | doc_desc10 | capture.pdf  | regressionnine@mailinator.com | Test@123 |
      #| DRC_ATC_Required_doc_20 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.gif  | doc_desc9 | capture.gif  | doc_desc6 | capture.gif  | doc_desc11 | capture.gif  | doc_desc12 | capture.gif  | doc_desc10 | capture.gif  | regressionnine@mailinator.com  | Test@123 |
      | DRC_ATC_Required_doc_21 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.docx | doc_desc9 | capture.docx | doc_desc6 | capture.docx | doc_desc11 | capture.docx | doc_desc12 | capture.docx | doc_desc10 | capture.docx | regressionnine@mailinator.com | Test@123 |

  #   | DRC_ATC_Required_doc_22 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.xlsx | doc_desc9 | capture.xlsx | doc_desc6 | capture.xlsx | doc_desc11 | capture.xlsx | doc_desc12 | capture.xlsx | doc_desc10 | capture.xlsx | regressionnine@mailinator.com  | Test@123 |
  ...
  Scenario Outline: Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document
    ...
    Examples: 
      ...
      #| DRC_ATC_Required_doc_23 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.png  | doc_desc9 | capture.png  | doc_desc6 | capture.png  | doc_desc11 | capture.png  | doc_desc10 | capture.png  | regressionnine@mailinator.com  | Test@123 |
      #    | DRC_ATC_Required_doc_24 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.jpg  | doc_desc9 | capture.jpg  | doc_desc6 | capture.jpg  | doc_desc11 | capture.jpg  | doc_desc10 | capture.jpg  | regressionnine@mailinator.com  | Test@123 |
      | DRC_ATC_Required_doc_25 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.jpeg | doc_desc9 | capture.jpeg | doc_desc6 | capture.jpeg | doc_desc11 | capture.jpeg | doc_desc10 | capture.jpeg | regressionnine@mailinator.com | Test@123 |

  #  | DRC_ATC_Required_doc_26 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.pdf  | doc_desc9 | capture.pdf  | doc_desc6 | capture.pdf  | doc_desc11 | capture.pdf  | doc_desc10 | capture.pdf  | regressionnine@mailinator.com  | Test@123 |
  # | DRC_ATC_Required_doc_27 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.docx | doc_desc9 | capture.docx | doc_desc6 | capture.docx | doc_desc11 | capture.docx | doc_desc10 | capture.docx | regressionnine@mailinator.com  | Test@123 |
  # | DRC_ATC_Required_doc_28 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.gif  | doc_desc9 | capture.gif  | doc_desc6 | capture.gif  | doc_desc11 | capture.gif  | doc_desc10 | capture.gif  | regressionnine@mailinator.com  | Test@123 |
  #| DRC_ATC_Required_doc_29 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.xlsx | doc_desc9 | capture.xlsx | doc_desc6 | capture.xlsx | doc_desc11 | capture.xlsx | doc_desc10 | capture.xlsx | regressionnine@mailinator.com  | Test@123 |
  ...
  Scenario Outline: Check the Delete Functionality
    ...
    Examples: 
      ...
      | DRC_ATC_Required_doc_44 | Check the Delete Functionality | doc_desc1_1 | Capture.png | regressionnine@mailinator.com | Test@123 |
  ...
  Scenario Outline: User is on Required Documents page and wants to redirect to Bank Details page.
    ...
    Examples: 
      ...
      | DRC_ATC_Required_doc_45 | User is on Required Documents page and wants to redirect to Bank Details page.(Individual)          | Natural Person | Individual        |     | 4843758943798 | 2018-06-10 | Newman | Mining | 2018-06-10 | Small Scale | 8965741235698 |              |               | regressionnine@mailinator.com | Test@123 |
      | DRC_ATC_Required_doc_46 | User is on Required Documents page and wants to redirect to Bank Details page.(Government Entity  ) | Legal Entity   | Government Entity |     | 4843758943798 | 2018-06-10 | Newman |      3 | 2018-08-22 | Mining      | 2018-08-22    | Medium Scale | 8965741235698 | regressionnine@mailinator.com | Test@123 |
      # | DRC_ATC_Required_doc_47 | User is on Required Documents page and wants to redirect to Bank Details page.( Incorporated Bodies Y)   | Legal Entity   | Incorporated Bodies  | Yes | 4843758943798 | 2018-06-10 | Newman |      3 | 2018-06-10 | Mining      | 2018-06-10    | Medium Scale | 8965741235698 | regressionnine@mailinator.com  | Test@123 |
     # | DRC_ATC_Required_doc_48 | User is on Required Documents page and wants to redirect to Bank Details page. (Incorporated Bodies N) | Legal Entity   | Incorporated Bodies | No  | 4843758943798 | 2018-06-10 | Newman |      3 | 2018-06-10 | Mining      | 2018-06-10    | Medium Scale | 8965741235698 | regressionnine@mailinator.com  | Test@123 |
      #| DRC_ATC_Required_doc_49 | User is on Required Documents page and wants to redirect to Bank Details page. (Other Non-Corporates  Y) | Legal Entity   | Other Non-Corporates | Yes | 4843758943798 | 2018-06-10 | Newman |      3 | 2018-06-10 | Mining      | 2018-06-10    | Medium Scale | 8965741235698 | regressionnine@mailinator.com  | Test@123 |
      #| DRC_ATC_Required_doc_50 | User is on Required Documents page and wants to redirect to Bank Details page.(Other Non-Corporates N)   | Legal Entity   | Other Non-Corporates | No  | 4843758943798 | 2018-06-10 | Newman |      3 | 2018-06-10 | Mining      | 2018-06-10    | Medium Scale | 8965741235698 | regressionnine@mailinator.com  | Test@123 |
