Feature: User is on Assessed List Landing Screen
  ...
  Scenario Outline: Validate Assessed status - internal portal
    ...
    Examples: 
      ...
      | Assessed List_08 | Validate Assessed status | txt_PeriodFeb | Reassess      | txt_2019_Period | Regression AprilTOne |

  #@TC_07_AssessedList_2882
  @TC_07_TC_03_AssessedList_2882
  Scenario Outline: Validate In Progress status and Validate reassess option from manage dropdown
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Dashboard
    And User click on Assessment Tab
    And User click on Assessed List
    ...
    Examples: 
      ...
      | Assessed List_07 | Validating status is changed to in progress and Validate Reassess Options | txt_PeriodFeb | drp_Status | txt_Assessed | drp_ReAssess | In Progress | txt_2019_Period |
  ...
  #| Assessed List_03 | Validate Reassess Options | txt_PeriodFeb | Regression AprilTOne | txt_2019_Period |
  ...
  Scenario Outline: Validate ReferenceID generated is not duplicate
    ...
    Examples: 
      ...
      | Assessed List_04 | Validate ReferenceID | txt_PeriodFeb | txt_2019_Period |
  ...
  Scenario Outline: Validate NITVA number displayed with the particular tax payer.
    ...
    Examples: 
      | TestcaseID       | Description       | Period        | Year            |
      | Assessed List_06 | Validate NITVA no | txt_PeriodFeb | txt_2019_Period |
  ...
  Scenario Outline: Validate whether user is able to filter by ReferenceID invalid
    ...
    Examples: 
      ...
      | Assessed List_11 | Validate ReferenceID | txt_PeriodFeb | drp_ReferanceId | 01212313 | @!@##$%^%$  | txt_2019_Period |
  ...
  Scenario Outline: Validate whether user  is able to filter by Assessed Date invalid
    ...
    Examples: 
      | TestcaseID         | Description            | Period        | Filter           | new | Specialchar | Year            |
      | Assessed List_11_1 | Validate Assessed Date | txt_PeriodFeb | drp_AssessedDate | 011 | @!@##$%^%$  | txt_2019_Period |
  ...
  Scenario Outline: Validate whether user is able to filter by NITVA invalid
    ...
    Examples: 
      | TestcaseID         | Description    | Period        | Filter    | new              | SpecialChar | Year            |
      | Assessed List_11_2 | Validate NITVA | txt_PeriodFeb | drp_NITVA | 0116666666666666 | !@#!@#$#$%4 | txt_2019_Period |
  ...
  Scenario Outline: Validate that the Total Reassessed(FC) tile amount when no any changes made in  re-assessment adjustment table for Operations Performed, Tax Deductible and Adjustment tab. - internal portal
    ...
    Examples: 
      ...
      | Ass_AS_05_06_19_18_16 | Validate Total Reassessed amount is same and check Additionality Liability | txt_PeriodFeb | txt_2019_Period | Regression AprilTOne | No Modification made for Assessment | File not found |
