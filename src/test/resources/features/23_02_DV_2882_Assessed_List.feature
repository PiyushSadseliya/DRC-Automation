Feature: User is on Assessed List Landing Screen
  ...
  Scenario Outline: Validate Tax Officer is able to View Notice internal portal
   ...
   @TC_03
   Scenario Outline: Validate reassess option from manage dropdown internal portal
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List
    And User click on drop down "<Period>" on assessed list
    ...
    Examples: 
      ...
      | Assessed List_03 | Validate Reassess Options | txt_PeriodJan | Arun     |
  ...
  Scenario Outline: Validate In Progress status. 
    ...
    Examples: 
      | TestcaseID       | Description                                 | Period        | Filter     | FilterStatus | check   | manageStatus | InProgress  | TaxPayer |
      | Assessed List_07 | Validating status is changed to in progress | txt_PeriodMar | drp_Status | txt_Assessed | Pending | drp_ReAssess | In Progress | Arun     |
  ...
  Scenario Outline: Validate Period Functionality 
    ...
    Examples: 
      ...
      | Assessed List_10 | Validate Assessed status | txt_PeriodJan_selected | txt_AssYear18 |
  ...
  Scenario Outline: Validate whether user  is able to filter by ReferenceID
    ...
    Examples: 
      ...
      | Assessed List_11 | Validate ReferenceID | txt_PeriodJan | drp_ReferanceId | CT18121300002 | CT18121300002 | 01212313 | @!@##$%^%$  |
  ...
  Scenario Outline: Validate whether user is able to filter by NITVA
    ...
    Examples: 
      | TestcaseID         | Description    | Period        | Filter    | Data              | check             | new              | SpecialChar |
      | Assessed List_11_2 | Validate NITVA | txt_PeriodJan | drp_NITVA | 20181211105214504 | 20181211105214504 | 0116666666666666 | !@#!@#$#$%4 |
  ...
  Scenario Outline: Validate whether user is able to filter by Tax Payer
    ...
    Examples: 
      ...
      | Assessed List_11_3 | Validate  Tax Payer | txt_PeriodJan | txt_TaxPayer | Rohit | xyz | !@#@#$@#    |
