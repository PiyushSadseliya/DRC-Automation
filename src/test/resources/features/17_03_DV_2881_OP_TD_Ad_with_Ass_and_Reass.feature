Feature: User is on Operation Performed Page Manual Assessement
  ...
  Scenario Outline: Validate the NITVA field,Period field
    ...
    Examples: 
      ...
      | Mal_OP_02_03 | validate nitva no,Period field | txt_PeriodJan | Arun111223 | txt_2019_Period |
  ...
  Scenario Outline: Validate Total Additional liability.
    ...
    Examples: 
      | TestcaseID | Description                         | Period        | TaxPayer   | Year            |
      | Mal_OP_06  | Validate Total Additional liability | txt_PeriodJan | Arun111223 | txt_2019_Period |
  ...
  Scenario Outline: Validate the Edit button functionality and Save button functionality
    ...
    Examples: 
      ...
      | Mal_OP_08_20 | Validate edit and save button functionality | txt_PeriodJan | Arun111223 | 10000 | 7000 | 5000 | 500 | 500 | 500 | 500 | 500 | 500 | Saved Successfully | 1000 | 1000 | 1000 | 1000 | 1000 | 1000 | 1000 | 1000 | 1000 | txt_2019_Period |
  ...
  Scenario Outline: Validate the view icon in transaction received table and difference amount calculate
    ...
    Examples: 
      | TestcaseID   | Description                                              | Period        | TaxPayer   | Year            |
      | Mal_OP_10_11 | Validate Total Additional liability and amount calculate | txt_PeriodJan | Arun111223 | txt_2019_Period |
  ...
  Scenario Outline: Validate total row under Other e-declaration table , total amount for taxable turnover,next and prev,previous,transaction received button and e-filing schedule button
    ...
    Examples: 
      ...
      | Mal_OP_13_14_15_16_17_19 | Validate total row,amount for taxable turnover,next and prev,previous,transaction received,e-filing schedule button | txt_PeriodMar | Arun111223 | File not found | txt_2019_Period |
  ...
  Scenario Outline: Validate the download functionality of e-filing schedule button when e-file schedule file is uploaded by tax payer from tax payer portal
    ...
    Examples: 
      | TestcaseID | Description                       | Period        | TaxPayer   | Year            |
      | Mal_OP_18  | Validate e-filing schedule button | txt_PeriodJan | Arun111223 | txt_2019_Period |
  ...
  Scenario Outline: Validate Negative Scenario for all fields
    ...
    Examples: 
      ...
      | Mal_OP_NS_1 | Validate special chatracter | txt_PeriodJan | Arun111223 | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | txt_2019_Period |
      | Mal_OP_NS_2 | Validate alpha numeric      | txt_PeriodJan | Arun111223 | A12  | B123 | C465 | D234 | E234 | F123 | G123 | H123 | I123 | txt_2019_Period |
  ...
  Scenario Outline: Validate Negative Scenario for all fields length
    ...
    Examples: 
      ...
      | Mal_OP_NS_Field_Length_1 | Validate length of number | txt_PeriodJan | txt_2019_Period | Arun111223 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 |
