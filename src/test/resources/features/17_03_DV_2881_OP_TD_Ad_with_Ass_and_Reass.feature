Feature: User is on Operation Performed Page Manual Assessement
  ...
  Scenario Outline: Validate the NITVA field,Period field 
    ...
    Examples: 
      ...
      | Mal_OP_02_03 | validate nitva no,Period field | txt_PeriodJan | Arun111223 |
  ...
  Scenario Outline: Validate Total Additional liability. 
    ...
    Examples: 
      | TestcaseID | Description                         | Period        | TaxPayer   |
      | Mal_OP_06  | Validate Total Additional liability | txt_PeriodJan | Arun111223 |
  ...
  Scenario Outline: Validate the Edit button functionality and Save button functionality
    ...
    Examples: 
      | TestcaseID   | Description                                 | Period        | TaxPayer   |     1 |    2 |  2.1 |   3 |   4 |   5 |   6 |   7 |   8 | SaveMess           |   01 |   02 | 02.1 |   03 |   04 |   05 |   06 |   07 |   08 |
      | Mal_OP_08_20 | Validate edit and save button functionality | txt_PeriodJan | Arun111223 | 10000 | 7000 | 5000 | 500 | 500 | 500 | 500 | 500 | 500 | Saved Successfully | 1000 | 1000 | 1000 | 1000 | 1000 | 1000 | 1000 | 1000 | 1000 |
  ...
  Scenario Outline: Validate the view icon in transaction received table and difference amount calculate 
    ...
    Examples: 
      | TestcaseID   | Description                                              | Period        | TaxPayer   |
      | Mal_OP_10_11 | Validate Total Additional liability and amount calculate | txt_PeriodJan | Arun111223 |
  ...
  Scenario Outline: Validate total row under Other e-declaration table , total amount for taxable turnover,next and prev,previous,transaction received button and e-filing schedule button
    ...
    Examples: 
      | TestcaseID               | Description                                                                                                         | Period        | TaxPayer   | FNF            |
      | Mal_OP_13_14_15_16_17_19 | Validate total row,amount for taxable turnover,next and prev,previous,transaction received,e-filing schedule button | txt_PeriodMar | Arun111223 | File not found |
  ...
  Scenario Outline: Validate the download functionality of e-filing schedule button when e-file schedule file is uploaded by tax payer from tax payer portal
    ...
    Examples: 
      | TestcaseID | Description                       | Period        | TaxPayer   |
      | Mal_OP_18  | Validate e-filing schedule button | txt_PeriodJan | Arun111223 |
  ...
  Scenario Outline: Validate Negative Scenario for all fields
    ...
    Examples: 
      | TestcaseID  | Description                 | Period        | TaxPayer   |    1 |    2 |  2.1 |    3 |    4 |    5 |    6 |    7 |    8 |
      | Mal_OP_NS_1 | Validate special chatracter | txt_PeriodJan | Arun111223 | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ |
      | Mal_OP_NS_2 | Validate alpha numeric      | txt_PeriodJan | Arun111223 | A12  | B123 | C465 | D234 | E234 | F123 | G123 | H123 | I123 |
  ...
  Scenario Outline: Validate Negative Scenario for all fields length
    ...
    Examples: 
      | TestcaseID               | Description               | Period        | TaxPayer   |                1 |                2 |              2.1 |                3 |                4 |                5 |                6 |                7 |                8 |
      | Mal_OP_NS_Field_Length_1 | Validate length of number | txt_PeriodJan | Arun111223 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 |
