Feature: User is on Tax Deductible Page Assessed List
  ...
  Scenario Outline: Validate the NITVA field,Period field
    ...
    Examples: 
      ...
      | Ass_Tax_Dec_02_03 | validate nitva no,Period field | txt_PeriodFeb | Regression AprilTOne | txt_2019_Period |
  ...
  Scenario Outline: Validate amount in Total Assessed tile,Total Ressessed tile,Total Additional liability tile
    ...
    Examples: 
      ...
      | Ass_Tax_Dec_05_06_07 | validate Total Assessed tile,Total Ressessed tile,Total Additional liability tile | txt_PeriodFeb | txt_2019_Period | Regression AprilTOne | 500 |  500 | 500 |  500 | 500 |  500 | 500 |  500 |
  ...
  Scenario Outline: Validate the Edit button functionality,next button when officer edit the fields on the page, Save button functionality
    ...
    Examples: 
      ...
      | Ass_Tax_Dec_08_18_20 | validate Edit button functionality,next button when officer edit the fields on the page, Save button functionality | txt_PeriodFeb | txt_2019_Period | Regression AprilTOne |  5 |    5 |  0 |    0 |  0 |    0 |  0 |    0 | Saved Successfully |
  ...
  Scenario Outline: Validate the view icon in transaction received table and Total of Difference field.
    ...
    Examples: 
      | TestcaseID        | Description                                                                    | Period        | TaxPayer               | Year            |
      | Ass_Tax_Dec_11_12 | validate view icon in transaction received table and Total of Difference field | txt_PeriodFeb | Regression AprilTOne | txt_2019_Period |
  ...
  Scenario Outline: Validate the download functionality of e-filing schedule button when e-file schedule file is uploaded by tax payer from tax payer portal
    ...
    Examples: 
      | TestcaseID     | Description                                                  | Period        | TaxPayer               | Year            |
      | Ass_Tax_Dec_15 | validate  download functionality of e-filing schedule button | txt_PeriodFeb | Regression AprilTOne | txt_2019_Period |
  ...
  #| Ass_Tax_Dec_14_16_17_19_21 | validate view icon in transaction received table and Total of Difference field | txt_PeriodFeb | Regression AprilTOne| File not found | txt_2019_Period |
  ...
  Scenario Outline: Validate Negative Scenario for all fields
    ...
    Examples: 
      | TestcaseID               | Description               | Period        | Year            | TaxPayer               |               10 |             10.1 |               11 |             11.1 |               12 |             12.1 |               13 |             13.1 |
      | Ass_OP_NS_Field_Length_1 | Validate length of number | txt_PeriodFeb | txt_2019_Period | Regression AprilTOne | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 |
  ...
  Scenario Outline: Validate Negative Scenario for all fields
    ...
    Examples: 
      ...
      | Ass_OP_NS_1 | Validate special chatracter | txt_PeriodFeb | Regression AprilTOne | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | txt_2019_Period |
      | Ass_OP_NS_2 | Validate alpha numeric      | txt_PeriodFeb | Regression AprilTOne | A12  | B465 | C465 | D234 | E234 | F123 | G123 | H123 | txt_2019_Period |
