...
Feature: Upload Documents after all process are completed till the Banks details
  ...
  Scenario Outline: Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document
    ...
    Examples: 
      ...
      | DRC_ATC_Required_doc_16 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.png  | doc_desc9 | capture.png  | doc_desc6 | capture.png  | doc_desc11 | capture.png  | doc_desc12 | capture.png  | doc_desc10 | capture.png  | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_17 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.jpg  | doc_desc9 | capture.jpg  | doc_desc6 | capture.jpg  | doc_desc11 | capture.jpg  | doc_desc12 | capture.jpg  | doc_desc10 | capture.jpg  | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_18 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.jpeg | doc_desc9 | capture.jpeg | doc_desc6 | capture.jpeg | doc_desc11 | capture.jpeg | doc_desc12 | capture.jpeg | doc_desc10 | capture.jpeg | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_19 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.pdf  | doc_desc9 | capture.pdf  | doc_desc6 | capture.pdf  | doc_desc11 | capture.pdf  | doc_desc12 | capture.pdf  | doc_desc10 | capture.pdf  | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_20 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.gif  | doc_desc9 | capture.gif  | doc_desc6 | capture.gif  | doc_desc11 | capture.gif  | doc_desc12 | capture.gif  | doc_desc10 | capture.gif  | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_21 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.docx | doc_desc9 | capture.docx | doc_desc6 | capture.docx | doc_desc11 | capture.docx | doc_desc12 | capture.doc  | doc_desc10 | capture.doc  | nov13@sharklasers.com | 123456 |
  ...
  Scenario Outline: Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document
    ...
    Examples: 
      ...
      | DRC_ATC_Required_doc_23 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.png  | doc_desc9 | capture.png  | doc_desc6 | capture.png  | doc_desc11 | capture.png  | doc_desc10 | capture.png  | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_24 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.jpg  | doc_desc9 | capture.jpg  | doc_desc6 | capture.jpg  | doc_desc11 | capture.jpg  | doc_desc10 | capture.jpg  | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_25 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.jpeg | doc_desc9 | capture.jpeg | doc_desc6 | capture.jpeg | doc_desc11 | capture.jpeg | doc_desc10 | capture.jpeg | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_26 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.pdf  | doc_desc9 | capture.pdf  | doc_desc6 | capture.pdf  | doc_desc11 | capture.pdf  | doc_desc10 | capture.pdf  | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_27 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.docx | doc_desc9 | capture.docx | doc_desc6 | capture.docx | doc_desc11 | capture.docx | doc_desc10 | capture.docx | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_28 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.gif  | doc_desc9 | capture.gif  | doc_desc6 | capture.gif  | doc_desc11 | capture.gif  | doc_desc10 | capture.gif  | nov13@sharklasers.com | 123456 |
  ...
  Scenario Outline: User is on Required Documents page and wants to redirect to Bank Details page.
    ...
    Examples: 
      ...
      | DRC_ATC_Required_doc_45 | User is on Required Documents page and wants to redirect to Bank Details page.(Individual)               | Natural Person | Individual           |     | 4843758943798 | 2018-06-10 | Newman | Mining | 2018-06-10 | Small Scale | 8965741235698 |              |               | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_46 | User is on Required Documents page and wants to redirect to Bank Details page.(Government Entity  )      | Legal Entity   | Government Entity    |     | 4843758943798 | 2018-06-10 | Newman |      3 | 2018-01-20 | Mining      | 2018-06-10    | Medium Scale | 8965741235698 | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_47 | User is on Required Documents page and wants to redirect to Bank Details page.( Incorporated Bodies Y)   | Legal Entity   | Incorporated Bodies  | Yes | 4843758943798 | 2018-06-10 | Newman |      3 | 2018-06-10 | Mining      | 2018-06-10    | Medium Scale | 8965741235698 | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_48 | User is on Required Documents page and wants to redirect to Bank Details page. (Incorporated Bodies N)   | Legal Entity   | Incorporated Bodies  | No  | 4843758943798 | 2018-06-10 | Newman |      3 | 2018-06-10 | Mining      | 2018-06-10    | Medium Scale | 8965741235698 | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_49 | User is on Required Documents page and wants to redirect to Bank Details page. (Other Non-Corporates  Y) | Legal Entity   | Other Non-Corporates | Yes | 4843758943798 | 2018-06-10 | Newman |      3 | 2018-06-10 | Mining      | 2018-06-10    | Medium Scale | 8965741235698 | nov13@sharklasers.com | 123456 |
      | DRC_ATC_Required_doc_50 | User is on Required Documents page and wants to redirect to Bank Details page.(Other Non-Corporates N)   | Legal Entity   | Other Non-Corporates | No  | 4843758943798 | 2018-06-10 | Newman |      3 | 2018-06-10 | Mining      | 2018-06-10    | Medium Scale | 8965741235698 | nov13@sharklasers.com | 123456 |
