...
Feature: List of Debt Cases Assigned to the Collection Officer – Reassign
  ...
  Scenario Outline: Validate the Expected recovery and Percentage functionality
    ...
    Examples: 
      ...
      | DRC_ATC_AssignedDebt_TotalArrears_PopUp_01 | Validate the Expected recovery and Percentage functionality. | Jainik Patel | ketan.prajapati | admin    | 0-3 Months | amount | R18112900000003 |       8000,00 |       60 |     60 |       100 |Regression AprilDebt | 8.000,00 |      0,00 | 8.000,00 |
  ...
  Scenario Outline: Validate actions payment requested.
   ...
   Then attach the document"<path>"
    ...
    Examples: 
      ...
      | DRC_ATC_AssignedDebt_TotalArrears_PopUp_03 | Validate actions payment requested. | Jainik Patel | ketan.prajapati | admin    | 0-3 Months | 2018-09-20 | 2018-09-20 |     6000|       60 |     60 |           | Capture.PNG |         0 | 8.000,00 |Regression AprilDebt |    100 |      0,00 | Please pay the pending debts at the earliest |
