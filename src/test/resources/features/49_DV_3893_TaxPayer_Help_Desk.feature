Feature: User is on Tax Payer Portal Help Desk
  ...
  #  And User click here for first time
   ...
   And User enter in add new button frame   
    ...
    Examples: 
      ...
      | TaxPayer_Helpdesk_01 | Verify System related issue extra | smokeatuser61@mt2015.com | Test@123 | drp_Select_SRI | System Related4 | Creating System related issue |
  ...
  Scenario Outline: Validate the Information Received status for the Helpdesk ticket
    ...
    Examples: 
      ...
      | TaxPayer_Helpdesk_28_01 | TaxOfficer comment for Information Received status | The Additional information are | smokeatuser61@mt2015.com | Test@123 | Information Received |
  ...
  Scenario Outline: Validate the Information Received status for the Helpdesk ticket -taxpayer portal
    ...
    Examples: 
      ...
      | TaxPayer_Helpdesk_28_02 | TaxPayer enter responce for Information Received status | The Additional information are | smokeatuser61@mt2015.com | Test@123 | Information Received |
  ...
  Scenario Outline: Validate Communication functionality when current status is close -taxpayer portal
    ...
    Examples: 
      ...
      | TaxPayer_Helpdesk_36 | Verify Communication functionality when current status is close | smokeatuser61@mt2015.com | Test@123 | Officers List With Tax Center.xlsx | close       |
