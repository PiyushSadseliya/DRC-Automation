Feature: End2End Functional Smoke TestSuite Spirit wise
  ...
  Scenario Outline: Validate functionality of VAT Registration Dashboard - tax payer portal
    ...
    Examples: 
      ...
      | TC_End2End_01 | Registartion Process | Legal Entity | Government Entity | ADFSNKPABV00100 | 2019-01-12            | 1Rivet Smoke   | ABC09ABC09AGC09 | 2019-01-12         | Mining        | 2019-01-12 | Large Scale  | 85000000 | Dharamdas Chamber | Near Axis Bank | Bas-Uele | Aketi |  444604 |   9898984565 | DRCBusiness | Dharamdas Chamber | Near Axis Bank | Ituri     | Aru   |   444604 | businesss@mt2015.com |    7896541023 | Yes    | Business Analyst | John  | jack@2015mt.com | 7412508963 | 00112233440077 | John Martin         | Advans Bank | Branch4 | doc_desc1              | test.png | doc_desc1              | test.png | doc_desc1              | test.png | doc_desc1              | test.png | doc_desc1              | test.png | doc_desc1              | test.png |              |
  ...
  Scenario Outline: Validate functionality of FX- management - Supervisor
  ...
  Scenario Outline: Validate functionality of Payment_Agreement
    ...
    Examples: 
      ...
      | DRC_ATC_Payment_Agrement_Tax_Officer | Validate functionality of Payment_Agreement | drp_CM_TaxPayer_Click | 1Rivet Smoke | Open       | Under Review      |     10 | 100000000000 | Amount should be less than the difference of total and discount. |

  @SP_15_Account_Adjustment
  Scenario Outline: Validate functionality of Account Adjustment for General - Internal portal
    Given "<Test Case Id>""<Description>" The officer has logged in with Username "<uname>" and Password "<pwd>"
  ...
  Scenario Outline: Validate functionality of Help-Desk Module - Tax Payer Portal
    ...
    Examples: 
      ...
      | TC_Helpdesk_01 | Help-Desk   | System Related Issue | Test From Automation | Test Automation from taxpayer | Device not working properly |
  ...
  Scenario Outline: Validate functionalioty of IT-support Admin module - Internal Portal
    ...
    Examples: 
      ...
      | TC_ITSupport_01 | IT-Support -Internal | General Query | Demo_environment_ | Test From Automation IT-Support internal | Record Added Successfully |

  @SP_18.2_IT_Support
  Scenario Outline: Validate the IT support User's module functionality - ituser
    ...
    Examples: 
      ...
      | TC_18.1.1          | kalpesha@mailinator.com | Test@123 | High     | In Progress | Test From Automation | Issue Updated |
      | TC_18.1.2          | kalpesha@mailinator.com | Test@123 | Medium   | On - Hold   | Test From Automation | Issue Updated |
      | TC_18.1.3          | kalpesha@mailinator.com | Test@123 | Low      | Resolved    | Test From Automation | Issue Updated |
  ...
  Scenario Outline: Validate functionalioty of Fuel Management module - Internal Portal
    ...
    Examples: 
      ...
      | TC_Fuelmanagement_01 | Fuel management-Admin |    100 |     85 |       90 |  10 |       10 |       15 | Fuel price Accepted successfully |
  ...
  Scenario Outline: Validate functionality of Fuel-management with tax-officer - Internal portal
    ...
    Examples: 
      | TestCase_Id          | Description                 | Petrol | Diesel | Keresone | CNG | Methanol | Gasoline | ToastMessage                     |
      | TC_Fuelmanagement_01 | Fuel management-Tax-officer |    100 |     85 |       90 |  10 |       10 |       15 | Fuel price Accepted successfully |
