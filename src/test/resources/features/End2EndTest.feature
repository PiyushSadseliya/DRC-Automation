Feature: End2End Functional Smoke TestSuite
  ...
  Scenario Outline: Validate functionality of VAT Registration Dashboard - tax payer portal
    ...
    Examples: 
      ...
      | TC_End2End_01 | Registartion Process | Legal Entity | Government Entity | ADFSNKPABV00100 | 2019-01-12            | 1Rivet Smoke   | ABC09ABC09AGC09 | 2019-01-12         | Mining        | 2019-01-12 | Large Scale  | 75000000 | Dharamdas Chamber | Near Axis Bank | Bas-Uele | Aketi |  444604 |   1234567890 | DRCBusiness | Dharamdas Chamber | Near Axis Bank | Ituri     | Aru   |   444604 | abc@gmail.com |    7896541023 | Yes    | Business Analysit | John  | john@gmail.com | 7412508963 | 00112233440077 | John Martin         | Advans Bank | Branch4 | doc_desc1              | test.png | doc_desc1              | test.png | doc_desc1              | test.png | doc_desc1              | test.png | doc_desc1              | test.png | doc_desc1              | test.png |              |
  ...
  Scenario Outline: Validate functionality of Assessment - Internal Portal
    ...
    Examples: 
      ...
      | TC_Assessment_01 | assessment  | Manual Assessment | January | 2019 | NITVA  | 1Rivet Smoke  | Assess   | Assessment Successfully Completed   |
      | TC_Assessment_02 | assessment  | Assessed List     | January | 2019 | NITVA  | 1Rivet Smoke  | Reassess | Reassessment Successfully Completed |
  ...
  Scenario Outline: Validate functionalioty of Fuel Management module - Internal Portal
    ...
    Examples: 
      ...
      | TC_Fuelmanagement_01 | Fuel management-Admin |     78 |     85 |       90 |  10 |       10 |       15 | Fuel price Accepted successfully |
