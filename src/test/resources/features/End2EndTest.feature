Feature: End2End Functional Smoke TestSuite
  ...
  Scenario Outline: Validate functionality of VAT Registration Dashboard - tax payer portal
    ...
    Examples: 
      | TestCase_Id   | Description          | Category     | SubCategory       | Nif             | Nif Registration Date | FName Business | COI             | Incorporation Date | Business Type | Start Date | Company Size | Revenue   | AddressLine1 | AddressLine2    | Province | City  | ZipCode | MobileNumber | BName       | BAddressLine1 | BAddressLine2  | BProvince | BCity | BZipCode | BEmail         | BMobileNumber | Option | Job Title        | FName   | AEmail         | Mobile     | Account Number | Account Holder Name | Bank Name   | Branch  | A1Document Description | A1Status | A2Document Description | A2Status | A3Document Description | A3Status | A4Document Description | A4Status | A5Document Description | A5Status | A6Document Description | A6Status | ToastMessage |
      | TC_End2End_01 | Registartion Process | Legal Entity | Government Entity | ADFSNKPABV00100 | 2019-02-13            | Dev SmokeUser        | ABC09ABC09AGC09 | 2019-02-13         | Manufacturing | 2019-02-13 | Large Scale  | 900000000 | Valsad GIDC  | Near False Town | Bas-Uele | Aketi |  444604 |   1234567890 | DRCBusiness | Tithal Street | Near Axis Bank | Ituri     | Aru   |   444604 | frnd@gmail.com |    7896541023 | Yes    | Business Analyst | QASmoke | john@gmail.com | 7412508963 |         112233 | Nien Martin         | Advans Bank | Branch4 | doc_desc1              | test.png | doc_desc1              | test.png | doc_desc1              | test.png | doc_desc1              | test.png | doc_desc1              | test.png | doc_desc1              | test.png |              |
  ...
  Scenario Outline: Validate functionality of E-filling - Tax Payer Portal
    ...
    Examples: 
      ...
      | TC_Efile_01 | Enter data in E-filling form | 5000 | 200 | 100 | 200 | 100 | 100 |    150 |    120 |         120 |     120 |     200 |     10 |     10 |            10 |            10 |      20 |      20 |           50 |                     50 |           50 |       20 |       100 | Scenario.xlsx | signature            |
  ...
  Scenario Outline: Validate functionality of FX- management with supervisor role - supervisor
    Given User Login with Admin's credentials
    When Click on Fx management tab
  ...
  Scenario Outline: Validate functionality of Assessment - Internal Portal
    ...
    And search for the records and click on search button
    ...
    Examples: 
      | TestCase_Id      | Description | Assesment         | Month   | Year | Filter | Action   | ToastMessage                        |
      | TC_Assessment_01 | assessment  | Manual Assessment | January | 2019 | NITVA  | Assess   | Assessment Successfully Completed   |
      | TC_Assessment_02 | assessment  | Assessed List     | January | 2019 | NITVA  | Reassess | Reassessment Successfully Completed |
  ...
  Scenario Outline: Validate functionality of assign officer Debt Management - Internal Portal
  ...
  Scenario Outline: Validate functionality of Debt Management payment requested - Internal Portal
    ...
    Examples: 
      | Test Case ID            | Description                        | Filter | officername  | RecoverAmount | Rpercent | PerRec | path        | RecAmount | comment                                      |
      | DRC_ATC_AssignedDebt_01 | Validate actions payment requested | NITVA  | Jainik Patel |           500 |      100 |    100 | Capture.pdf |       100 | Please pay the pending debts at the earliest |
  ...
  Scenario Outline: Validate functionality of Account Adjustment for General - Internal portal
    Given "<Test Case Id>""<Description>" the officer has on Account_Adjustment
    ...
    Examples: 
      | Test Case Id          | Description                     | Filter | action  | user  | src                 | ApproveO | reason       | comments            | charge | vatLiab | ltfee | pen  | btn      |
      | DRC_ATC_ACCAdjstmt_01 | Validate the Account Adjustment | NITVA  | General | Ketan | Internal adjustment | Akib     | System Error | Adjusted the amount | Credit |    5000 |  5000 | 5000 | previous |

  @SP_17.1_Manufacturer_Portal
  Scenario Outline: Validate functionality of EFD module - manufacturer portal
    Given User Login with Manufacturer credentials
    When Click on Vendor registartion tab
    And Click on Register Vendor Button
    And Fill the Details of Vendor via manufacturer "<NIF>" , "<NIFDate>" , "<VName>" , "<VMobileNumber>" ,"<VEmail>"
    ...
    Examples: 
      ...
      | TC_MP_01    | FX-supervisor | 100330131011 | 2018-12-22 | Deno  |          9824 | deno@yopmail.com | Lisa  |          8745 | lisa@mt2015.com | Valsad       | Kongo Central | Banana | Vendor has been registered successfully |

  @SP_17.2_Vendor_Portal
  Scenario Outline: Validate functionality of EFD Vendor module - vendor portal
    ...
    And Fill the Details of Vendor "<SIM1>" , "<SIM2>" , "<TypeOfDevice>" ,"<EFDModule>" ,"<EFDID>"
  ...
  Scenario Outline: Validate functionality of Help-Desk Module - Tax Payer Portal
    ...
    Examples: 
      ...
      | TC_Helpdesk_01 | Help-Desk   | System Related Issue | QA_HelpDesk | Test Automation from taxpayer | Device not working properly |
  ...
  Scenario Outline: Validate functionality of Tax-Payer Profile - Internal Portal
    ...
    And search by "<Filter>" and hit search button
  ...
  Scenario Outline: Validate functionalioty of IT-support Admin module - Internal Portal
    ...
    Examples: 
      | TestCase_Id     | Description          | IssueType     | ITitle          | IDescription                             | comments     | file        | ToastMessage              |
      | TC_ITSupport_01 | IT-Support -Internal | General Query | QA_environment_ | Test From Automation IT-Support internal | File updated | capture.pdf | Record Added Successfully |

  @SP_18.2_IT_SupportUser
  Scenario Outline: Validate the IT support User functionality - ituser
  ...
  Scenario Outline: Validate functionalioty of Fuel Management module - Internal Portal
    ...
    And Check for the Current updated date
    And Click on update fuel rate
    ...
    Examples: 
      ...
      | TC_Fuelmanagement_01 | Fuel management-Admin |     80 |     70 |       50 |  40 |       60 |       65 | Fuel price Accepted successfully |

  @SP_19.2_Fuel_Management_Supervisor
  Scenario Outline: Validate functionality of Fuel management with Supervisor role
    Given User login in Internal portal
    When Click on Fuel management tab
  ...
  @SP_19.3_Fuel_Management_Taxofficer
  Scenario Outline: Validate functionality of Fuel-management with tax-officer
    Given User login in Internal portal
    When Click on Fuel management tab
    And Check for the Current updated date
    And Click on Historical Fuel Rates
    And Click on previous button
    And Click on update fuel rate
    And update the rate as "<Petrol>" ,"<Diesel>" ,"<Keresone>" ,"<CNG>" ,"<Methanol>" ,"<Gasoline>"
    And click on save button
    ...
    Examples: 
      | TestCase_Id          | Description                 | Petrol | Diesel | Keresone | CNG | Methanol | Gasoline | ToastMessage                     |
      | TC_Fuelmanagement_01 | Fuel management-Tax-officer |    100 |     85 |       90 |  40 |       35 |       20 | Fuel price Accepted successfully |

  @SP_20.1_VATRateManagement
  Scenario Outline: Validate Admin able to update and send the same for approval -  internal portal
    ...
    Then Select Category "Foods and Beverage"
    ...
    #Then Click on filterby on VAT Rate management
    #Then Select "Category"
    #Then Select Category "Fuel wood, Wood Charcoal"
    #Then Click on search button
    ...
    Then Click on filterby on VAT Rate management
    Then Select "Status"
    Then Select Category "Approval Pending"
    Then Click on search button
    ...
    Examples: 
      ...
      | DRC_ATC_VATRATE_01 | Validate Admin able to update and send the same for approval. | Exempt     |

  @SP_20.2_VATRateManagementApprove
  Scenario Outline: Validate Supervisor is able to approve the edited rate - supervisor
    Given "<Test Case ID>""<Description>"The officer has logged in to internal portal
    When Clicks on the VAT Rate Management menu
    Then Should be on "VAT Rate by Commodity" page
    ...
    Examples: 
      ...
      | DRC_ATC_VATRATE_14 | Validate Supervisor is able to approve the edited rate |
