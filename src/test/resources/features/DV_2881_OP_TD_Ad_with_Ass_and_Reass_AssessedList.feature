Feature: User is on Operation Performed Page Assessed List
 ...
 #   And User see next button is disable
  ...
  Scenario Outline: Validate the download functionality of e-filing schedule button when e-file schedule file is uploaded by tax payer from tax payer portal
    ...
    Examples: 
      | TestcaseID | Description                       | Period        | nitva             |
      | Ass_OP_19  | Validate e-filing schedule button | txt_PeriodJan | 20181026120648410 |
  ...
  Scenario Outline: Validate Negative Scenario for all fields
    ...
    Examples: 
      ...
      | Ass_OP_NS_1 | Validate special chatracter | txt_PeriodJan | 20181026120648410 | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ | @!@$ |
      | Ass_OP_NS_2 | Validate alpha numeric      | txt_PeriodJan | 20181026120648410 | A12  | B465 | C465 | D234 | E234 | F123 | G123 | H123 | I123 |
  ...
  Scenario Outline: Validate Negative Scenario for all fields
    ...
    Examples: 
      | TestcaseID               | Description               | Period        | nitva             |                1 |                2 |              2.1 |                3 |                4 |                5 |                6 |                7 |                8 |
      | Ass_OP_NS_Field_Length_1 | Validate length of number | txt_PeriodJan | 20181026120648410 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 |
