...
Feature: Manual ReAssessment- Payment summary for Liability Calculation and Payment due and Raise notice
  ...
  Scenario Outline: Validate the download functionality of e-filing schedule Button when e-file schedule file is not uploaded by tax payer from tax payer portal
    ...
    Examples: 
      ...
      | DRC_ATC_ReAssessment_01 | Validate the download functionality of  e-filing schedule Button when e-file schedule file is not uploaded by tax payer from tax payer portal | ritesh.prajapati | admin    | January | 2018 | Saved Successfully | 500000 |          800 | 20181011030459642 | power1234 | nvat | New Oct Ten |
  ...
  Scenario Outline: Validate the Save,Previous button,Total Tiles,Additionality Liability column for No updation in manual assessment when efiling and pymt not done
    ...
    Examples: 
      ...
      | DRC_ATC_ReAssessment_03 | Validate the Save,Previous button,prev button,next button Total Tiles,Additionality Liability column | ritesh.prajapati | admin    | January | 2018 | Saved Successfully | 500000 |       800,00 | 20181011030459642 | power1234 | Saved Successfully | New Oct Ten |
  ...
  Scenario Outline: Validate the prev button,next button for no updation in manual assessment when efiling and pymt not done
    ...
    Examples: 
      ...
      | DRC_ATC_ReAssessment_04 | Validate the prev button,next button for no updation in manual assessment when efiling and pymt not done | ritesh.prajapati | admin    | January | 2018 | 500000 |       800,00 | 20181011030459642 | power1234 | New Oct Ten |
 ...
 When the assessemnt officer does the Reassessment for that particular month with "no" Updation for period"<period>"year"<year>"tpayer"<tpayer>"
    ...
    Examples: 
      | Test Case ID            | Description                                                                                                                                             | uname            | password | period  | year | msg                | penamt | efiledamount | NITVA             | nif       | nvat | tpayer      |
      | DRC_ATC_ReAssessment_02 | Validate the tax assessment officer is able to raise notice for a particular period for no updation in manual assessment when efiling and pymt not done | ritesh.prajapati | admin    | January | 2018 | Saved Successfully | 500000 |          800 | 20181011030459642 | power1234 | nvat | New Oct Ten |
