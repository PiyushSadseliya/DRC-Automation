...
public class Manual_Asseement_Purchase_Transaction_Domestic_and_Import 
{
	
	@And("^User click on view icon for domestic purchase$")
	public void user_click_on_view_icon_for_domestic_purchase() throws Throwable 
	{
		  clickOn("btn_SalesDomesticAsst", "");	    
	}

	@And("^User verify the NITVA number \"([^\"]*)\" for domestic purchase$")
	public void user_verify_the_NITVA_number_for_domestic_purchase(String value) throws Throwable 
	{  
	...
	@And("^User verify another nitva number \"([^\"]*)\" for domestic purchase$")
	public void user_verify_another_nitva_number_for_domestic_purchase(String value) throws Throwable 
	{
		if(wd.findElement(By.xpath("(//*[contains(text(),'" + value + "')])[1]")).isDisplayed() )
		{					
			assertTrue(true);
	...
	public void user_verify_month_for_sale_adjustement_for_domestic_purchase() throws Throwable
	{
	...
	public void user_navigate_to_domestic_purchase_page() throws Throwable 
	{
		WebElement we;
	...
	@And("^User click on previous button and again click on view icon for domestic purchase and check data \"([^\"]*)\" is reset$")
	public void user_click_on_previous_button_and_again_click_on_view_icon_for_domestic_purchase_and_check_data_is_reset(String value) throws Throwable 
	{
		WebElement we;
		//locator
	...
	@And("^User check invoice number \"([^\"]*)\" for domestic purchase$")
	public void user_check_invoice_number_for_domestic_purchase(String value) throws Throwable
	{
		if(wd.findElement(By.xpath("(//*[contains(text(),'" + value + "')])[1]")).isDisplayed() )
		{		
	...
	public void user_check_sales_type_and_NITVA_of_customer_for_domestic_purchase_sales(String value, String value1) throws Throwable
	{
	...
	@And("^User check for single Commodity Service Code for sales \"([^\"]*)\" for domestic purchase$")
	public void user_check_for_single_Commodity_Service_Code_for_sales_for_domestic_purchase(String value) throws Throwable 
	{
		if(wd.findElement(By.xpath("(//*[contains(text(),'" + value + "')])[1]")).isDisplayed() )
		{		
	...
	public void user_check_for_multiple_Commodity_Service_Code_for_domestic_purchase(String value, String value1) throws Throwable 
	{
		...
		{		
			System.out.println("User see multiple commodity");
			assertTrue(true);
		}
	}
	...
	public void verify_the_value_in_Total_Quantity_Total_Gross_Amount_VAT_Amount_and_Net_Amount_displayed_above_the_table_for_domestic_purchase() throws Throwable
	{
	...
	public void user_click_on_view_icon_in_purchase_for_import_purchase() throws Throwable 
	{
		clickOn("btn_Purchase_DomesticAsst", "");	    
	}

	@And("^User verify another nitva number \"([^\"]*)\" for import purchase$")
	public void user_verify_another_nitva_number_for_import_purchase(String value) throws Throwable 
	{
		if(wd.findElement(By.xpath("(//*[contains(text(),'" + value + "')])[1]")).isDisplayed() )
		{					
			assertTrue(true);
	...
	public void user_verify_month_for_import_purchase() throws Throwable
	{
	...
	public void user_navigate_to_import_purchase_page() throws Throwable
	{
	  
		WebElement we;
		we=wd.findElement(By.xpath("//div[text()='Imoort Purchase']"));		
		if(we.isDisplayed())
		{			
			assertTrue(true);
		}
	}
	@And("^User click on previous button and again click on view icon for import purchase and check data \"([^\"]*)\" is reset for import purchase$")
	public void user_click_on_previous_button_and_again_click_on_view_icon_for_import_purchase_and_check_data_is_reset_for_import_purchase(String value) throws Throwable 
	{
	...
	//07
	@And("^User click on previous button and again click on view icon for domestic purchase and check data \"([^\"]*)\" is reset for import purchase$")
	public void user_click_on_previous_button_and_again_click_on_view_icon_for_domestic_purchase_and_check_data_is_reset_for_import_purchase(String value) throws Throwable 
	{
	...
	@And("^User check invoice number \"([^\"]*)\" for import purchase$")
	public void user_check_invoice_number_for_import_purchase(String value) throws Throwable 
	{
		if(wd.findElement(By.xpath("(//*[contains(text(),'" + value + "')])[1]")).isDisplayed() )
		{		
			System.out.println("User see invoice number ");
