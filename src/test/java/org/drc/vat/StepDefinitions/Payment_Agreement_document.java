...
public class Payment_Agreement_document 
{
	...
	public void user_verify_Annexure_A_Page_no_date_and_installement_amount() throws Throwable 
	{
...
*/
	...
	{
		/*if(wd.findElement(By.xpath("//div/table/tbody/tr[1]/td[1]/div")).isDisplayed() )
		{					
			assertTrue(true);
		}
		*/
		...
		/*int sum = 0;
		List<WebElement> elementName =  wd.findElements(By.xpath("//div/table/tbody/tr[1]/td[1]/div"));
		for(int i = 1;i<elementName.size()+1;i++)
		{
			WebElement element1 = wd.findElement(By.xpath("//div/table/tbody/tr["+i+"]/td[1]/div"));
