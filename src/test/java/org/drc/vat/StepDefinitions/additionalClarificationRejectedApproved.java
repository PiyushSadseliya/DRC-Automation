...
public class additionalClarificationRejectedApproved {
	...
	public void the_officer_has_Rejected_the_form_and_The_User_is_on_Dashboard_After_Successfully_login_from_taxpayer_portal(String username, String password, String arg3, String arg4)throws Throwable {	
	sleepWait(10000);
	...
	public void the_officer_Ask_for_additional_clarification_in_the_form_and_The_User_is_on_Dashboard_After_Successfully_login_from_taxpayer_portal( String username, String password,String arg1, String arg2) throws InterruptedException 
		{
		login(username,password);
	}
	...
	public void clicks_on_Reply_button_enters_comment_along_with_the_documents(String comment) throws InterruptedException {
		sleepWait(2000);
		clickOn("btn_reply","");
		// Write code here that turns the phrase above into concrete actions
	...
	public void may_edit_reg_address_of_business(String arg1, String arg2, String arg3, String arg4, String arg5, String arg6,String arg7) throws Throwable {
		// Write code here that turns the phrase above into concrete actions
	...
	public void clicks_on_Reply_button_enters_comment_along_with_the_documents(String comment, String doctype, String desc, String filepath) throws Throwable {
		...
		sleepWait(3000);
		clickOn("lbl_uploaddocs", "/following::span[contains(text(),'" + doctype + "')]");//span[contains(text(),'Bank Account Proof')]
		sleepWait(3000);
	...
	public void the_DGI_officer_has_approved_for_NITVA_and_The_User_is_on_Dashboard_After_Successfully_login_from_taxpayer_portal(String uname, String pwd, String arg3, String arg4) throws Throwable {
