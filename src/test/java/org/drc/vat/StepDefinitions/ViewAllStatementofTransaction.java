...
//login(arg3, arg4);
	...
	public void statement_of_Transaction_should_display(String arg1) throws Throwable {
		List<WebElement> noelement = wd.findElements(
				By.xpath("//h5[contains(text(),'Statement of Transaction')]/following::table//tbody//tr//td"));
		if (noelement.size() < 2) {
	...
	public void statemnt_of_Transaction_should_show_the_details_of_Date_Period_Particular_OpeningBalance_Liability_Amount_Late_Fee_Interest_Penalty_Total(
		...
		/*
		 * System.out.println(wd.findElement(By.xpath("//tbody/tr["+arg1+"]/td[1]")).
		 * getText()); System.out.println(date);
		 * System.out.println(wd.findElement(By.xpath("//tbody/tr["+arg1+"]/td[2]")).
		 * getText()); System.out.println(period+","+year);
		 * System.out.println(wd.findElement(By.xpath("//tbody/tr["+arg1+"]/td[3]")).
		 * getText()); System.out.println(particular);
		 * System.out.println(wd.findElement(By.xpath("//tbody/tr["+arg1+"]/td[4]")).
		 * getText()); System.out.println(OpeningBal);
		 * System.out.println(wd.findElement(By.xpath("//tbody/tr["+arg1+"]/td[5]")).
		 * getText()); System.out.println(vamount);
		 * System.out.println(wd.findElement(By.xpath("//tbody/tr["+arg1+"]/td[6]")).
		 * getText()); System.out.println(ltfee);
		 * System.out.println(wd.findElement(By.xpath("//tbody/tr["+arg1+"]/td[7]")).
		 * getText()); System.out.println(interest);
		 * System.out.println(wd.findElement(By.xpath("//tbody/tr["+arg1+"]/td[8]")).
		 * getText()); System.out.println(penalty);
		 * System.out.println(wd.findElement(By.xpath("//tbody/tr["+arg1+"]/td[9]")).
		 * getText()); System.out.println(total);
		 */
		// logout();
	}
