...
public class Installment_Schedule_Pop_up_show 
{
	...
	public void use_validate_number_are_in_acending_order() throws Throwable 
	{
		...
		/*int sum = 0;
		List<WebElement> elementName =  wd.findElements(By.xpath("//tr[1]/td[1]/div"));
		for(int i = 1;i<elementName.size()+1;i++)
		{
			WebElement element1 = wd.findElement(By.xpath("//tr["+i+"]/td[1]/div"));
