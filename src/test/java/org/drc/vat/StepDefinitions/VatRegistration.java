...
public class VatRegistration {
	...
	public void user_is_on_VAT_Registration_Dashboard() throws Throwable {
		/*for(int i=0;i<5;i++)
	{
		String Firstname = "bindi0";
		String Lastname ="@mailinator.com";
		String UName = Firstname.concat(Integer.toString(i)).concat(Lastname);
	}
		type("txtbox_username","demouser02@mailinator.com");
		sleepWait(2000);
	...
	public void enters_NIF_Registration_Date_Date_of_Incorporation_Type_Of_Business(String NIFDate, String IncorpDate, String BusinessType) throws Throwable {
	...
	public void enters_Business_Start_Date_Company_Size_Last_Year_Revenue(String BStartDate, String CompanySize) throws Throwable {
	...
	public void enters_Address_Details(String Address1, String Address2, String Province, String City, String ZipCode, String MobileNumber) throws Throwable {
	...
	public void enters_Business_details(String BName,String BAddress1, String BAddress2, String BProvince, String BCity, String BZipCode, String BEmail, String BMobileNumber) throws Throwable {
		type("txtbox_bname",BName);
		type("txtbox_buspromadd1",BAddress1);
		
		type("txtbox_buspromadd2",BAddress2);
		clickOn("buspromprovince","");sleepWait(2000);
		...
		if(we.isEnabled())
		{
			clickOn("buspromcity","");sleepWait(1000);
	...
	public void select_Authorization_signature_with_Job_Title_Full_Name_Email_Mobile_Number(String Opt, String JobTitle, String FullName, String Email, String MobileNumber) throws Throwable {
	...
	public void select_Address_Proof_of_Registered_Place_of_Business_for(String Document1, String status1) throws Throwable {
	...
	public void select_Letter_of_Authorization_Board_Resolution_for_Authorized_Signatory_Download_Template_for(String Document5, String status5) throws Throwable {
	...
	public void connect_database_and_execute_query_and_run_successfully() throws Throwable {
		ConnectDatabase CD = new ConnectDatabase();
		CD.opendb();
		String sql= "declare @month int"
				+"set @month =1"
				+"insert into vat.VfVateFile"
		...
		String Sql1="declare @FY int"
				+"set @FY=1"
				+"insert into vat.VfVateFileActivity"
				+"(VfVateFileId,VfActivityId,VfStatusId,CreatedDate)"
				+"values"
	...
	public void clicks_on_e_filing_to_fill_data() throws Throwable {
		...
		for(int i =1;i<=12;i++)
		{
			...
			sleepWait(2000);
			if(B)
				//if (wd.findElement(By.xpath("//button[text()='Preview']")).isDisplayed())
			{
				//return;
				continue;
			}
	...
	public void enter_data_in_Operation_Performed(String DG, String DS1, String DS2, String DGI, String DSI, String FPP, String Export, String Exempt, String Nontaxable) throws Throwable {
		...
		Total_VC = ((Float.parseFloat(DG))*16/100) + ((Float.parseFloat(DS2))*16/100) + ((Float.parseFloat(DGI))*16/100)+ ((Float.parseFloat(DSI))*16/100)+((Float.parseFloat(FPP))*16/100);
...
public void enter_sales_data_in_E_filling(String SalesDomestic1, String SalesExport1, String SalesAdjustment1, String SalesDomestic2, String SalesExport2, String SalesAdjustment2) throws Throwable {
...
public void enter_Purchase_data_in_E_filling(String PDomestic1, String PImport1, String PAdjustment1, String PDomestic2, String PImport2, String PAdjustment2) throws Throwable {
...
public void enter_Adjustment_data_in_E_filing(String invoice1, String credit1, String debit1, String invoice2, String credit2, String debit2) throws Throwable {
    type("txtbox_invoicetotal",invoice1);
    type("txtbox_credittotal",credit1);
    type("txtbox_debittotal",debit1);
	...
	public void enter_OTP_and_click_on_verify_button_and_click_on_Ok_button() throws Throwable {
		...
		Read_OTP otp = new Read_OTP();
		String OTP = otp.ReadOTP();
...
public void clicks_on_purchase_domestic_icon_redirect_to_sales_page_and_click_on_previous_button() throws Throwable {
...
public void clicks_on_purchase_adjustment_icon_redirect_to_sales_page_and_click_on_previous_button() throws Throwable {
