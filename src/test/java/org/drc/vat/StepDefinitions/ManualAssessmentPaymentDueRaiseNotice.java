...
public class ManualAssessmentPaymentDueRaiseNotice {
	...
	public void the_tax_officer_has_logged_in_and_has_done_Liability_Calculation(String arg1, String arg2)
			throws Throwable {
	...
	public void validate_the_ReferenceID_Period_DateIssued_taxCentre(String refid, String period, String issueddate,
			String taxcentre) throws Throwable {
		// Write code here that turns the phrase above into concrete actions
