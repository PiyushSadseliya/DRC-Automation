...
public class AccountAdjustmentStmtofTransac {
	...
	public void the_officer_has_logged_in_with_Uname_Password(String arg1, String arg2) throws Throwable {
	...
	@Then("^by default Source value is \"([^\"]*)\"$")
	public void by_default_Source_value_is(String arg1) throws Throwable {
	...
	@Then("^the total amount for charge \"([^\"]*)\" in Adjustment Record must be \"([^\"]*)\"$")
	public void the_total_amount_for_charge_in_Adjustment_Record_must_be(String arg1, String arg2) throws Throwable {
