...
//-----------------------------------------------------//
	...
	@Then("^go to last page and it should display revelant data$")
	public void go_to_last_page_and_it_should_display_revelant_data() throws Throwable 
	{
		clickOn("Last","");
		Thread.sleep(2000);
	}

	@And("^filter the record on first page and check \"([^\"]*)\"$")
	public void filter_the_record_on_first_page_and_check(String value) throws Throwable 
	{
		String name= wd.findElement(By.xpath("//*[@placeholder='Type here']")).getText();
		System.out.println(name);		
		
		WebElement errorMessage= wd.findElement(By.xpath("//*[@ng-reflect-model='" + value + "']"));
		Assert.assertEquals(errorMessage.getText(),value);
	}
	/*@And("^filter the record on first page \"([^\"]*)\"$")
	public void filter_the_record_on_first_page(String value) throws Throwable 
	{
		//type("TypeHere",value);
		WebElement fName=wd.findElement(By.name("firstName"));
		  fName.sendKeys(value);
		  System.out.println(fName.getText());
		WebElement ele = wd.findElement(By.name("placeholder"));
		System.out.println(ele.getAttribute("value"));
	}*/

	/*@And("^check the data from first page \"([^\"]*)\"$")
	public void check_the_data_from_first_page(String value) throws Throwable 
	{
	//	type("TypeHere",value);
		//type("start","[contains(text(),'" + value + "')]");
		//type("start","input[@ng-reflect-model='" +value+ "'");
		Thread.sleep(2000);
		System.out.println("Checked");
		//input[@ng-reflect-model="11"]
	}*/
///------------------------------------------------//
