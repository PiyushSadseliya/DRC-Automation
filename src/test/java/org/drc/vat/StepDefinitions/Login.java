...
public class Login {
	...
	/*
	 * @And("^User Enter Same Email: \"([^\"]*)\"$") public void
	 * i_Enter_Same_Email(String sameEmail) throws Throwable {
	...
	/*
	 * @And("^Clicks on SendOTP$") public void clicks_on_SendOTP() throws Throwable
	 * { clickOn("btn_SendOtp", ""); //sleepWait(1000); }
	 */

	/*
	 * @And("^User wait for OTP to come on Email and Enter OTP$") public void
	 * user_wait_for_OTP_to_come_on_Email() throws Throwable { //sleepWait(10000);
	 * clickOn("btn_Verify", ""); }
	 */

	/*
	 * @And("^User Enter new Password \"([^\"]*)\"$") public void
	 * user_Enter_new_Password(String newPass) throws Throwable {
	 * type("txtbox_NewPassword",newPass); //sleepWait(1000); }
	 * 
	 * @When("^User Enter Confirm Password \"([^\"]*)\"$") public void
	 * user_Enter_Confirm_Password(String confirm) throws Throwable {
	 * type("txtbox_ConfirmPassword",confirm); // sleepWait(1000); }
	 */

	/*
	 * @And("^User Clicks on Reset Password$") public void
	 * user_Clicks_on_Reset_Password() throws Throwable {
	 * clickOn("btn_ResetPassword", ""); //sleepWait(1000); }
	 */

	/*
	 * @And("^User Clicks on Go to Sign In$") public void
	 * user_Clicks_on_Go_to_Sign_In() throws Throwable { clickOn("GotoSignIn", "");
	 * //sleepWait(1000); }
	 */
