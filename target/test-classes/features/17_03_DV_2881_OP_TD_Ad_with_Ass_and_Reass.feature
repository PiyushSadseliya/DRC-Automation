 ...
 #   Given User is on Assessment Page
  ...
  Scenario Outline: Validate the NITVA field,Period field internal portal
    ...
    Examples: 
      ...
      | Mal_OP_02_03 | validate nitva no,Period field | txt_PeriodJan | 20181026120648410 |
  ...
  Scenario Outline: Validate Total Additional liability.
    ...
    Examples: 
      | TestcaseID | Description                         | Period        | nitva             |
      | Mal_OP_06  | Validate Total Additional liability | txt_PeriodJan | 20181026120648410 |
  ...
  #  And User see next button is disable
    Examples: 
      ...
      | Mal_OP_08_20 | Validate edit and save button functionality | txt_PeriodFeb | 20181016011333143 | 10000 | 7000 | 5000 | 500 | 500 | 500 | 500 | 500 | 500 | Saved Successfully | 1000 | 1000 | 1000 | 1000 | 1000 | 1000 | 1000 | 1000 | 1000 |
  ...
  Scenario Outline: Validate the view icon in transaction received table and difference amount calculate
    ...
    Examples: 
      | TestcaseID   | Description                                              | Period        | nitva             |
      | Mal_OP_10_11 | Validate Total Additional liability and amount calculate | txt_PeriodFeb | 20181016011333143 |
  ...
  Scenario Outline: Validate total row under Other e-declaration table , total amount for taxable turnover,next and prev,previous,transaction received button and e-filing schedule button
    ...
    Examples: 
      ...
      | Mal_OP_13_14_15_16_17_19 | Validate total row,amount for taxable turnover,next and prev,previous,transaction received,e-filing schedule button | txt_PeriodJan | 20181026120648410 | File not found |
  ...
  Scenario Outline: Validate the download functionality of e-filing schedule button when e-file schedule file is uploaded by tax payer from tax payer portal
    ...
    Examples: 
      | TestcaseID | Description                       | Period        | nitva             |
      | Mal_OP_18  | Validate e-filing schedule button | txt_PeriodJan | 20181022121408836 |
  ...
  Scenario Outline: Validate Negative Scenario for all fields
    ...
    Examples: 
      | TestcaseID               | Description                | Period        | nitva             |                1 |                2 |              2.1 |                3 |                4 |                5 |                6 |               7 |                8 |
      | Mal_OP_NS_Field_Length_1 | Validate length of number  | txt_PeriodFeb | 20181016025450411 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 |
