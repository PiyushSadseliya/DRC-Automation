...
Feature: List of Debt Cases Assigned to the Collection Officer – Reassign
  ...
  Scenario Outline: Validate the Expected recovery and Percentage functionality.
    ...
    Examples: 
      ...
      | DRC_ATC_AssignedDebt_TotalArrears_PopUp_01 | Validate the Expected recovery and Percentage functionality. | Jainik Patel | ketan.prajapati | admin    | 0-3 Months | amount | R18112900000003 |     826307.94 |       60 |     60 |       100 | Approved User | 826.307,94 |      0,00 | 826.307,94 |
  ...
  Scenario Outline: Validate actions payment requested.
    ...
    Examples: 
      | Test Case ID                               | Description                         | officername  | uname           | password | ageing5    | month5 | caseid          | fdate      | todate     | RecoverAmount | Rpercent | PerRec | RecAmount | path        | Areceived       | totaldue     | Bamount        | tpayer        | PerRec | RecAmount | comment                                      |
      | DRC_ATC_AssignedDebt_TotalArrears_PopUp_03 | Validate actions payment requested. | Jainik Patel | ketan.prajapati | admin    | 0-3 Months | amount | R18112900000003 | 2018-09-20 | 2018-09-20 |     715664.23 |       60 |     60 | 715664.23 | Capture.PNG | -201.604.921,85 | 1.192.773,72 | 202.797.695,57 | Approved User |    100 |      0,00 | Please pay the pending debts at the earliest |
