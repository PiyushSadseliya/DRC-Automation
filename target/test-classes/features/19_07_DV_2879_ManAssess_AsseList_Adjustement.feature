Feature: User is on Manual Assement on Adjustment Page
  ...
  Scenario Outline: Validate the NITVA field,Period field
    ...
    Examples: 
      ...
      | Man_Adj_02_03 | validate nitva no,Period field | txt_PeriodFeb | regressionforty | txt_2019_Period |
  ...
  Scenario Outline: validate Total additional liability tile on adjustment,Total Assessed tile,Edit button functionality,save button
    ...
    Examples: 
      ...
      | Man_Adj_07_06_08_09 | validate view icon in transaction received table and Total of Difference field | txt_PeriodFeb | regressionforty |  0 |  0 |  5 |  5 | Saved Successfully |   10 |   10 |   10 |   10 | txt_2019_Period |
  ...
  Scenario Outline: Validate the view icon in transaction received table and Total of Difference field under Amount column
    ...
    Examples: 
      | TestcaseID    | Description                                                                    | Period        | TaxPayer         | Year            |
      | Man_Adj_12_13 | validate view icon in transaction received table and Total of Difference field | txt_PeriodFeb | regressionforty | txt_2019_Period |
  ...
  Scenario Outline: Validate the prev button, next,previous, download functionality of Transaction Received button and e-filing schedule button functionality when file is not uploaded by tax payer
    ...
    Examples: 
      ...
      | Man_Adj_15_16_17_18_20 | validate view icon in transaction received table and Total of Difference field | txt_PeriodJan |txt_PeriodFeb| regressionforty | File not found | txt_2019_Period |
  ...
  Scenario Outline: Validate the e-filing schedule button functionality when e-file schedule file is uploaded by tax payer from tax payer portal
    ...
    Examples: 
      | TestcaseID | Description                                                        | Period        | TaxPayer         | Year            |
      | Man_Adj_19 | validate download functionality when user upload file on tax payer | txt_PeriodFeb | regressionforty | txt_2019_Period |
  ...
  Scenario Outline: Validate Negative Scenario for all fields length
    ...
    Examples: 
      ...
      | Man_Adj_1  | Validate length of number | txt_PeriodFeb | regressionforty | 1234567891011123 | 1234567891011123 | 1234567891011123 | 1234567891011123 | txt_2019_Period |
  ...
  Scenario Outline: Validate Negative Scenario for all fields
    ...
    Examples: 
      | TestcaseID | Description                 | Period        | TaxPayer         |   17 |   18 |   19 |   20 | Year            |
      | Man_Adj_1  | Validate special chatracter | txt_PeriodFeb | regressionforty | @!@$ | @!@$ | @!@$ | @!@$ | txt_2019_Period |
      | Man_Adj_2  | Validate alpha numeric      | txt_PeriodFeb | regressionforty | A12  | B123 | C465 | D234 | txt_2019_Period |
