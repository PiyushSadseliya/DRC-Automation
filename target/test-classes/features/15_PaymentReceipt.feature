...
Feature: Payment Receipt
  ...
  Scenario Outline: Validate the payment Receipt for payment done against particular Month
    ...
    Examples: 
      ...
      | DRC_ATC_PaymentReceipt_02 | Validate the functionality of View button located on the statement of transaction section of e-filing landing page | refac@mailinator.com | Test@123 | Access Bank – Dba – Banque Privee Du Congo (Bpc) | Test Refac | 20180926012113710 | refac@mailinator.com | 340653459035 | test |         | 800.00 |    0 |    0 |      0 |      800 | Eight Hundred | Net banking | January |
