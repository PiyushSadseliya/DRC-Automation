Feature: Manual Assessment/Reassessment -Purchase - Transaction received - Domestic & Import View  (Manual Assment)
  ...
  Scenario Outline: Sales Adjustement Page
    ...
    Examples: 
      ...
      | Manual_Purchase_Domestic_and_Import_01 | laxman.prajapati | admin    |

  #@TC_01  UI Part
  #Scenario: Validate the UI of Domestic Sale purchase under Assessed List module
  ...
  #
  #  And User click on view icon in purchase for domestic
  #  And User navigate to Domestic sales
  #Examples:
  #|TestcaseID                            |Description| Period|Data|
  #|Manual_Purchase_Domestic_and_Import_01|Verify the UI of the Page|PeriodJan|Pending|
  @TC_02
  Scenario Outline: Validate the tax payers NITVA number displaying on the top of Domestic purchase Page
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    ...
    Examples: 
      ...
      | Manual_Purchase_Domestic_and_Import_02 | Validating NITVA number | PeriodJan | pending | 20180705073851634 | 20180705073851634 |
  ...
  Scenario Outline: Validate the Period field displaying on the top of Domestic page of Manual Assessement module
    ...
    Examples: 
      | TestcaseID                             | Description             | Period    | Data              |
      | Manual_Purchase_Domestic_and_Import_03 | Validating Period field | PeriodJan | 20180705073851634 |

  #@TC_04  Not yet implemented
  #Scenario: Validate the "?" (help) icon displayed on the top right cornor of the Domestic purchase page of Manual Assessement module
  ...
  #Examples:
  #  | TestcaseID           | Description             | Period    | Data              |
  #  | Manual_Purchase_Domestic_and_Import_04 | Validating Period field | PeriodJan | 20180705073851634 |
  @TC_05
  Scenario Outline: Validate the functionality of Previous button on Domestic Sale Page of Manual assessment module
    ...
    Examples: 
      | TestcaseID                             | Description                | Period    | Data              |
      | Manual_Purchase_Domestic_and_Import_05 | Validting Previous buttton | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate the Pagination functionality on Domestic Sale Page of Manual assessment module
    ...
    Examples: 
      ...
      | Manual_Purchase_Domestic_and_Import_06 | Last and Next      | PeriodJan | AssLast     | AssestRight |
      | Manual_Purchase_Domestic_and_Import_07 | Last and Previous  | PeriodJan | AssLast     | AssestLeft  |
      | Manual_Purchase_Domestic_and_Import_08 | Next and Last      | PeriodJan | AssestRight | AssLast     |
      | Manual_Purchase_Domestic_and_Import_09 | Next and First     | PeriodJan | AssestRight | AssFirst    |
      | Manual_Purchase_Domestic_and_Import_10 | First and Previous | PeriodJan | AssFirst    | AssestLeft  |
      | Manual_Purchase_Domestic_and_Import_11 | First and First    | PeriodJan | AssFirst    | AssFirst    |

  @TC_07
  Scenario Outline: Validate the sorting in Commodity/Service code,Quantity,Gross Amount(FC),VAT Amount(FC),& Net Amount(FC) columns displayed on the Domestic Manual Assessement purchase page
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on drop down "<Period>"
    And User type "<Data>"
    ...
    Examples: 
      ...
      | Manual_Purchase_Domestic_and_Import_12 | Validating sorting functionality | PeriodJan | 20180705073851634 |             |            |            |          |             |             |             |          |          |           |        |        |           |        |        |      |
  ...
  Scenario Outline: Validate the value displayed in Total Quantity above the domestic purchase table
    ...
    Examples: 
      | TestcaseID                             | Description               | Period    | Data              |
      | Manual_Purchase_Domestic_and_Import_13 | Validating Total Quantity | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate the value displayed in Total Gross Amount(FC) above the domestic purchase table
    ...
    Examples: 
      | TestcaseID                             | Description                   | Period    | Data              |
      | Manual_Purchase_Domestic_and_Import_14 | Validating Total Gross Amount | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate the value displayed in VAT Amount(FC) above the domestic purchase table
    ...
    Examples: 
      | TestcaseID                             | Description                 | Period    | Data              |
      | Manual_Purchase_Domestic_and_Import_15 | Validating Total Vat Amount | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate the value displayed in Net Amount(FC) above the domestic purchase table
    ...
    Examples: 
      | TestcaseID                             | Description           | Period    | Data              |
      | Manual_Purchase_Domestic_and_Import_16 | Validating Net Amount | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate Invoice number is displaying as per data present under EFD device for that particular month
    ...
    Examples: 
      ...
      | Manual_Purchase_Domestic_and_Import_17 | Validating Invoice number | PeriodJan | 20180705073851634 | 18012018017 |
  ...
  Scenario Outline: Validate NITVA of customer is displaying as per data present under EFD device for that particular month
    ...
    Examples: 
      ...
      | Manual_Purchase_Domestic_and_Import_18 | Validating NITVA of customer number | PeriodJan | 20180705073851634 | Domestic | 20180705073851634 |
  ...
  Scenario Outline: Validate Commodity code of customer displaying as per data present under EFD device for that particular month.
    ...
    Examples: 
      ...
      | Manual_Purchase_Domestic_and_Import_19 | Validating Commodity code of customer | PeriodJan | 20180705073851634 | 6802-KEYBOARD | 6802-KEYBOARD | 6802-KEYBOARD |
  ...
  Scenario Outline: Validate Quantity and its units are  displaying as per data present under EFD device for that particular month.
    ...
    Examples: 
      ...
      | Manual_Purchase_Domestic_and_Import_20 | Validating Quantity and  units | PeriodJan | 20180705073851634 | lbl_quantity11 | lbl_unitPieces | lbl_invoice |
  ...
  Scenario Outline: Validate Cancelled Invoice numbers is not getting populated on Domestic Sales page.
    ...
    Examples: 
      | TestcaseID                             | Description        | Period    | Data              | quantity       | unit           | invoice     |
      | Manual_Purchase_Domestic_and_Import_21 | Validating invoice | PeriodJan | 20180705073851634 | lbl_quantity11 | lbl_unitPieces | lbl_invoice |

  ###################### manual for Purchase Import purchase start from here ###########################################################
  #@TC_01  UI Part
  #Scenario: Validate the UI of Import Purchase Page under Manual Assessment module
  #  Given User is on Assessment Page "<TestcaseID>" "<Description>"
  #  And User see Manual Assessment Page
  #And User click on drop down "<Period>"
  #  And User type "<Data>"
  ...
  #Examples:
  #|TestcaseID                            |Description| Period|Data|
  #|Manual_Purchase_Domestic_and_Import_22|Verify the UI of the Page|PeriodJan|Pending|
  @TC_02
  Scenario Outline: Validate the tax payers NITVA number displaying on the top of Import Purchase Page
    ...
    Examples: 
      | TestcaseID                             | Description             | Period    | Data    | NITVA             | nitvas2           |
      | Manual_Purchase_Domestic_and_Import_23 | Validating NITVA number | PeriodJan | pending | 20180705073851634 | 20180705073851634 |

  @TC_03
  Scenario Outline: Validate the Period field displaying on the top of Import purchase page of Manual Assessement module
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on drop down "<Period>"
    And User type "<Data>"
    ...
    Examples: 
      | TestcaseID                             | Description             | Period    | Data              |
      | Manual_Purchase_Domestic_and_Import_24 | Validating Period field | PeriodJan | 20180705073851634 |

  #@TC_04  Not yet implemented
  #Scenario: Validate the "?" (help) icon displayed on the top right cornor of the Import purchase page of manual assessment module
  #Given User is on Assessment Page
  #And   User click on Assessment Tab
  #And   User click on help icon
  #And User click on drop down "<Period>"
  ...
  #Examples:
  #  | TestcaseID           | Description             | Period    | Data              |
  #  | Manual_Purchase_Domestic_and_Import_25 | Validating Period field | PeriodJan | 20180705073851634 |
  @TC_05
  Scenario Outline: Validate the functionality of Previous button on Import purchase Page of Manual assessment module
    ...
    Examples: 
      | TestcaseID                             | Description                | Period    | Data              |
      | Manual_Purchase_Domestic_and_Import_26 | Validting Previous buttton | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate the Pagination functionality on Import purchase Page of Manual assessment module
    ...
    Examples: 
      | TestcaseID                             | Description        | Period    | ClickPage   | CheckPage   |
      | Manual_Purchase_Domestic_and_Import_27 | Last and Next      | PeriodJan | AssLast     | AssestRight |
      | Manual_Purchase_Domestic_and_Import_28 | Last and Previous  | PeriodJan | AssLast     | AssestLeft  |
      | Manual_Purchase_Domestic_and_Import_29 | Next and Last      | PeriodJan | AssestRight | AssLast     |
      | Manual_Purchase_Domestic_and_Import_30 | Next and First     | PeriodJan | AssestRight | AssFirst    |
      | Manual_Purchase_Domestic_and_Import_31 | First and Previous | PeriodJan | AssFirst    | AssestLeft  |
      | Manual_Purchase_Domestic_and_Import_32 | First and First    | PeriodJan | AssFirst    | AssFirst    |
  ...
  Scenario Outline: Validate the sorting in Commodity/Service code,Quantity,Gross Amount(FC),VAT Amount(FC),& Net Amount(FC) columns displayed on the Import purchase page
    ...
    And User click on NET Amount "<NETAmount>" and check "<NETAsc>" and see in asceding order
    And User again click on NET Amount "<NETAmount>" and check "<NETDec>" and see in decending order
    And User click on previous button and again click on view icon for import purchase and check data "<data>" is reset for import purchase

    Examples: 
      | TestcaseID                             | Description                      | Period    | Data              | ServiceCode | ServiceAsc | ServiceDec | Quantity | QuantityAsc | QuantityDec | GrossAmount | GrossAsc | GrossDec | VATAmount | VATAsc | VATDec | NETAmount | NETAsc | NETDec | data |
      | Manual_Purchase_Domestic_and_Import_33 | Validating sorting functionality | PeriodJan | 20180705073851634 |             |            |            |          |             |             |             |          |          |           |        |        |           |        |        |      |
  ...
  Scenario Outline: Validate the value displayed in Total Quantity above the Import purchase table
    ...
    Examples: 
      | TestcaseID                             | Description               | Period    | Data              |
      | Manual_Purchase_Domestic_and_Import_34 | Validating Total Quantity | PeriodJan | 20180705073851634 |

  @TC_09
  Scenario Outline: Validate the value displayed in Total Gross Amount above the Import purchase table
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on drop down "<Period>"
    And User type "<Data>"
    ...
    Examples: 
      | TestcaseID                             | Description                   | Period    | Data              |
      | Manual_Purchase_Domestic_and_Import_35 | Validating Total Gross Amount | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate the value displayed in VAT Amount above the Import purchase table
    ...
    Examples: 
      | TestcaseID                             | Description                 | Period    | Data              |
      | Manual_Purchase_Domestic_and_Import_36 | Validating Total Vat Amount | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate the value displayed in Net Amount above the Import purchase table
    ...
    Examples: 
      | TestcaseID                             | Description           | Period    | Data              |
      | Manual_Purchase_Domestic_and_Import_37 | Validating Net Amount | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate Invoice number is displaying as per data present under EFD device for that particular month
    ...
    Examples: 
      | TestcaseID                             | Description               | Period    | Data              | invoice     |
      | Manual_Purchase_Domestic_and_Import_38 | Validating Invoice number | PeriodJan | 20180705073851634 | 18012018017 |
  ...
  Scenario Outline: Validate NITVA of customer is displaying as per data present under EFD device for that particular month
    ...
    Examples: 
      | TestcaseID                             | Description                         | Period    | Data              | sale     | customer          |
      | Manual_Purchase_Domestic_and_Import_39 | Validating NITVA of customer number | PeriodJan | 20180705073851634 | Domestic | 20180705073851634 |
  ...
  Scenario Outline: Validate Commodity code of customer displaying as per data present under EFD device for that particular month.
    ...
    Examples: 
      | TestcaseID                             | Description                           | Period    | Data              | code          | code1         | code2         |
      | Manual_Purchase_Domestic_and_Import_40 | Validating Commodity code of customer | PeriodJan | 20180705073851634 | 6802-KEYBOARD | 6802-KEYBOARD | 6802-KEYBOARD |
  ...
  Scenario Outline: Validate Quantity and its units are  displaying as per data present under EFD device for that particular month.
    ...
    Examples: 
      | TestcaseID                             | Description                    | Period    | Data              | quantity       | unit           | invoice     |
      | Manual_Purchase_Domestic_and_Import_41 | Validating Quantity and  units | PeriodJan | 20180705073851634 | lbl_quantity11 | lbl_unitPieces | lbl_invoice |

  # On hold
  @TC_16
  Scenario Outline: Validate Cancelled Invoice numbers is not getting populated on Import purchase page.
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on drop down "<Period>"
    And User type "<Data>"
    ...
    Examples: 
      | TestcaseID                             | Description        | Period    | Data              | quantity       | unit           | invoice     |
      | Manual_Purchase_Domestic_and_Import_42 | Validating invoice | PeriodJan | 20180705073851634 | lbl_quantity11 | lbl_unitPieces | lbl_invoice |
