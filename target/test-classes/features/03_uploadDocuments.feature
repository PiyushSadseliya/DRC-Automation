...
Feature: Upload Documents after all process are completed till the Banks details
  ...
  # | DRC_ATC_Valid_Required_doc_04 | Tax payer Category as  Natural Person and  Tax payer Sub Category as Individual user wants to upload the document (.pdf)                  | doc_desc1_1 | capture.pdf        | doc_desc3 | capture.pdf        | doc_desc5 | capture.pdf        | doc_desc4 | capture.pdf        | approvedduser@mailinator.com  | Test@123 |
  # | DRC_ATC_Valid_Required_doc_05 | Tax payer Category as  Natural Person and  Tax payer Sub Category as Individual user wants to upload the document (.gif)                  | doc_desc1_1 | capture.gif        | doc_desc3 | capture.gif        | doc_desc5 | capture.gif        | doc_desc4 | capture.gif        | approvedduser@mailinator.com  | Test@123 |
  #| DRC_ATC_Valid_Required_doc_06 | Tax payer Category as  Natural Person and  Tax payer Sub Category as Individual user wants to upload the document (.docx)                 | doc_desc1_1 | capture.docx       | doc_desc3 | capture.docx       | doc_desc5 | capture.docx       | doc_desc4 | capture.docx       | approvedduser@mailinator.com  | Test@123 |
  #| DRC_ATC_Valid_Required_doc_07 | Tax payer Category as  Natural Person and  Tax payer Sub Category as Individual user wants to upload the document (.xlsx) | doc_desc1_1 | capture.xlsx | doc_desc3 | capture.xlsx | doc_desc5 | capture.xlsx | doc_desc4 | capture.xlsx | approvedduser@mailinator.com | Test@123 |
  ...
  Scenario Outline: Tax payer Category as Legal Entity and  Tax payer Sub Category as Governement Entity user wants to upload the document
    ...
    Examples: 
      ...
      #| DRC_ATC_Required_doc_12 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Governement Entity user wants to upload the document | doc_desc23 | capture.pdf  | doc_desc25 | capture.pdf  | doc_desc22 | capture.pdf  | doc_desc27 | capture.pdf  | doc_desc21 | capture.pdf  | doc_desc26 | capture.pdf  | approvedduser@mailinator.com  | Test@123 |
      #| DRC_ATC_Required_doc_13 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Governement Entity user wants to upload the document | doc_desc23 | capture.gif  | doc_desc25 | capture.gif  | doc_desc22 | capture.gif  | doc_desc27 | capture.gif  | doc_desc21 | capture.gif  | doc_desc26 | capture.gif  | approvedduser@mailinator.com  | Test@123 |
  ...
  Scenario Outline: Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document
    ...
    Examples: 
      ...
      | DRC_ATC_Required_doc_19 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.pdf  | doc_desc9 | capture.pdf  | doc_desc6 | capture.pdf  | doc_desc11 | capture.pdf  | doc_desc12 | capture.pdf  | doc_desc10 | capture.pdf  | approvedduser@mailinator.com | Test@123 |
      #| DRC_ATC_Required_doc_20 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.gif  | doc_desc9 | capture.gif  | doc_desc6 | capture.gif  | doc_desc11 | capture.gif  | doc_desc12 | capture.gif  | doc_desc10 | capture.gif  | approvedduser@mailinator.com  | Test@123 |
      | DRC_ATC_Required_doc_21 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is  LLP user wants to upload the document | doc_desc7 | capture.docx | doc_desc9 | capture.docx | doc_desc6 | capture.docx | doc_desc11 | capture.docx | doc_desc12 | capture.docx | doc_desc10 | capture.docx | approvedduser@mailinator.com | Test@123 |
  ...
  #  | DRC_ATC_Required_doc_26 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.pdf  | doc_desc9 | capture.pdf  | doc_desc6 | capture.pdf  | doc_desc11 | capture.pdf  | doc_desc10 | capture.pdf  | approvedduser@mailinator.com  | Test@123 |
  # | DRC_ATC_Required_doc_27 | Tax payer Category as Legal Entity and  Tax payer Sub Category as Incorporated Body and is not LLP user wants to upload the document | doc_desc7 | capture.docx | doc_desc9 | capture.docx | doc_desc6 | capture.docx | doc_desc11 | capture.docx | doc_desc10 | capture.docx | approvedduser@mailinator.com  | Test@123 |
  ...
  Scenario Outline: User is on Required Documents page and wants to redirect to Bank Details page.
    ...
    Examples: 
     ...
     # | DRC_ATC_Required_doc_48 | User is on Required Documents page and wants to redirect to Bank Details page. (Incorporated Bodies N) | Legal Entity   | Incorporated Bodies | No  | 4843758943798 | 2018-06-10 | Newman |      3 | 2018-06-10 | Mining      | 2018-06-10    | Medium Scale | 8965741235698 | approvedduser@mailinator.com  | Test@123 |
      #| DRC_ATC_Required_doc_49 | User is on Required Documents page and wants to redirect to Bank Details page. (Other Non-Corporates  Y) | Legal Entity   | Other Non-Corporates | Yes | 4843758943798 | 2018-06-10 | Newman |      3 | 2018-06-10 | Mining      | 2018-06-10    | Medium Scale | 8965741235698 | approvedduser@mailinator.com  | Test@123 |
      #| DRC_ATC_Required_doc_50 | User is on Required Documents page and wants to redirect to Bank Details page.(Other Non-Corporates N)   | Legal Entity   | Other Non-Corporates | No  | 4843758943798 | 2018-06-10 | Newman |      3 | 2018-06-10 | Mining      | 2018-06-10    | Medium Scale | 8965741235698 | approvedduser@mailinator.com  | Test@123 |
