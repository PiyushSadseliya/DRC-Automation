...
@tag
Feature: Manual Assessment/Reassessment -Sales - Transaction received - Domestic & Export View  (Assessed List)
 ...
 @TC_001
  ...
  #|Assessed_List_Sales_Domestic_Export_01|Verify the UI of the Page|PeriodJan|Pending|
  @TC_02
  Scenario Outline: Validate the tax payers NITVA number displaying on the top of Domestic Sales Page
    ...
    Examples: 
      ...
      | Assessed_List_Sales_Domestic_Export_02 | Validating NITVA number | PeriodJan | Assessed | 20180705073851634 | 20180705073851634 |
  ...
  Scenario Outline: Validate the Period field displaying on the top of Domestic page of Assessed List module
    ...
    Examples: 
      | TestcaseID           | Description             | Period    | Data              |
      | Assessed_List_Sales_Domestic_Export_03 | Validating Period field | PeriodJan | 20180705073851634 |

  #@TC_04  Not yet implemented
  #Scenario: Validate the "?" (help) icon displayed on the top right cornor of the Domestic sales page of Assessed List module
  ...
  #Examples:
  #  | TestcaseID           | Description             | Period    | Data              |
  #  | Assessed_List_Sales_Domestic_Export_04 | Validating Period field | PeriodJan | 20180705073851634 |
  @TC_05
  Scenario Outline: Validate the functionality of Previous button on Domestic Sale Page of Assessed List module
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on drop down "<Period>"
    And User type "<Data>"
    ...
    Examples: 
      | TestcaseID           | Description                | Period    | Data              |
      | Assessed_List_Sales_Domestic_Export_05 | Validting Previous buttton | PeriodJan | 20180705073851634 |

  @TC_06
  Scenario Outline: Validate the Pagination functionality on Domestic Sale Page of Assessed List module
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on drop down "<Period>"
    And User type "<Data>"
  ...
  Scenario Outline: Validate the sorting in Commodity/Service code,Quantity,Gross Amount(FC),VAT Amount(FC),& Net Amount(FC) columns displayed on the Domestic Sales page
    ...
    Examples: 
      ...
      | Assessed_List_Sales_Domestic_Export_12 | Validating sorting functionality | PeriodJan | 20180705073851634 |             |            |            |          |             |             |             |          |          |           |        |        |           |        |        |    |
  ...
  Scenario Outline: Validate the value displayed in Total Quantity above the domestic sales table
    ...
    Examples: 
      | TestcaseID           | Description               | Period    | Data              |
      | Assessed_List_Sales_Domestic_Export_13 | Validating Total Quantity | PeriodJan | 20180705073851634 |
 ...
 And User click on manage setting drop down and click on Reassess from list
    ...
    Examples: 
      | TestcaseID           | Description                   | Period    | Data              |
      | Assessed_List_Sales_Domestic_Export_14 | Validating Total Gross Amount | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate the value displayed in VAT Amount(FC) above the domestic sales table
    ...
    Examples: 
      | TestcaseID           | Description                 | Period    | Data              |
      | Assessed_List_Sales_Domestic_Export_15 | Validating Total Vat Amount | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate the value displayed in Net Amount(FC) above the domestic sales table
    ...
    Examples: 
      | TestcaseID           | Description           | Period    | Data              |
      | Assessed_List_Sales_Domestic_Export_16 | Validating Net Amount | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate Invoice number is displaying as per data present under EFD device for that particular month
    ...
    Examples: 
      ...
      | Assessed_List_Sales_Domestic_Export_17 | Validating Invoice number | PeriodJan | 20180705073851634 | 18012018017 |
  ...
  Scenario Outline: Validate NITVA of customer is displaying as per data present under EFD device for that particular month
   ...
   And User click on manage setting drop down and click on Reassess from list
    ...
    Examples: 
      ...
      | Assessed_List_Sales_Domestic_Export_18 | Validating NITVA of customer number | PeriodJan | 20180705073851634 | Domestic | 20180705073851634 |
  ...
  Scenario Outline: Validate Commodity code of customer displaying as per data present under EFD device for that particular month.
    ...
    Examples: 
      ...
      | Assessed_List_Sales_Domestic_Export_19 | Validating Commodity code of customer | PeriodJan | 20180705073851634 | 6802-KEYBOARD | 6802-KEYBOARD | 6802-KEYBOARD |
  ...
  Scenario Outline: Validate Quantity and its units are  displaying as per data present under EFD device for that particular month.
    ...
    Examples: 
      ...
      | Assessed_List_Sales_Domestic_Export_20 | Validating Quantity and  units | PeriodJan | 20180705073851634 | lbl_quantity11 | lbl_unitPieces | lbl_invoice |
  ...
  And User click on manage setting drop down and click on Reassess from list
    ...
    Examples: 
      | TestcaseID           | Description        | Period    | Data              | quantity       | unit           | invoice     |
      | Assessed_List_Sales_Domestic_Export_21 | Validating invoice | PeriodJan | 20180705073851634 | lbl_quantity11 | lbl_unitPieces | lbl_invoice |
      
      
      
  ###################### Assessed for Export start from here########################################################### 
  ...
  #Examples:
  #|TestcaseID          |Description| Period|Data|
  #|Assessed_List_Sales_Domestic_Export_22|Verify the UI of the Page|PeriodJan|Pending|
  ...
  Scenario Outline: Validate the tax payers NITVA number displaying on the top of Export Sales Page
    ...
    Examples: 
      | TestcaseID           | Description             | Period    | Data    | NITVA             | nitvas2           |
      | Assessed_List_Sales_Domestic_Export_23 | Validating NITVA number | PeriodJan | pending | 20180705073851634 | 20180705073851634 |
      
      
  @TC_03
  Scenario Outline: Validate the Period field displaying on the top of Export page of Assessed List module
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on drop down "<Period>"
    And User type "<Data>"
    ...
    Examples: 
      | TestcaseID           | Description             | Period    | Data              |
      | Assessed_List_Sales_Domestic_Export_24 | Validating Period field | PeriodJan | 20180705073851634 |
      
  #@TC_04  Not yet implemented
  #Scenario: Validate the "?" (help) icon displayed on the top right cornor of the Export sales page of Assessed List module
  #Given User is on Assessment Page
  #And   User click on Assessment Tab
  #And   User click on help icon
  #And User click on drop down "<Period>"
  ...
  #Examples:
  #  | TestcaseID           | Description             | Period    | Data              |
  #  | Assessed_List_Sales_Domestic_Export_25 | Validating Period field | PeriodJan | 20180705073851634 |  
  ...
  Scenario Outline: Validate the functionality of Previous button on Export Sale Page of Manual assessment module
    ...
    Examples: 
      | TestcaseID           | Description                | Period    | Data              |
      | Assessed_List_Sales_Domestic_Export_26 | Validting Previous buttton | PeriodJan | 20180705073851634 |
  ...
  And User click on manage setting drop down and click on Reassess from list
    ...
    Examples: 
      | TestcaseID           | Description                      | Period    | Data              | ServiceCode | ServiceAsc | ServiceDec | Quantity | QuantityAsc | QuantityDec | GrossAmount | GrossAsc | GrossDec | VATAmount | VATAsc | VATDec | NETAmount | NETAsc | NETDec |data|
      | Assessed_List_Sales_Domestic_Export_33 | Validating sorting functionality | PeriodJan | 20180705073851634 |             |            |            |          |             |             |             |          |          |           |        |        |           |        |        |    |
  ...
  Scenario Outline: Validate the value displayed in Total Quantity above the Export sales table
    ...
    Examples: 
      | TestcaseID           | Description               | Period    | Data              |
      | Assessed_List_Sales_Domestic_Export_34 | Validating Total Quantity | PeriodJan | 20180705073851634 |
 ...
 @TC_09
  Scenario Outline: Validate the value displayed in Total Gross Amount above the Export sales table
    ...
    Examples: 
      | TestcaseID           | Description                   | Period    | Data              |
      | Assessed_List_Sales_Domestic_Export_35 | Validating Total Gross Amount | PeriodJan | 20180705073851634 |     
  ...
  Scenario Outline: Validate the value displayed in VAT Amount above the Export sales table
    ...
    Examples: 
      | TestcaseID           | Description                 | Period    | Data              |
      | Assessed_List_Sales_Domestic_Export_36 | Validating Total Vat Amount | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate the value displayed in Net Amount above the Export sales table
    ...
    Examples: 
      | TestcaseID           | Description           | Period    | Data              |
      | Assessed_List_Sales_Domestic_Export_37 | Validating Net Amount | PeriodJan | 20180705073851634 |
  ...
  Scenario Outline: Validate Invoice number is displaying as per data present under EFD device for that particular month
    ...
    Examples: 
      | TestcaseID           | Description               | Period    | Data              | invoice     |
      | Assessed_List_Sales_Domestic_Export_38 | Validating Invoice number | PeriodJan | 20180705073851634 | 18012018017 |     
  ...
  Scenario Outline: Validate NITVA of customer is displaying as per data present under EFD device for that particular month
    ...
    Examples: 
      | TestcaseID           | Description                         | Period    | Data              | sale     | customer          |
      | Assessed_List_Sales_Domestic_Export_39 | Validating NITVA of customer number | PeriodJan | 20180705073851634 | Domestic | 20180705073851634 |
  ...
  Scenario Outline: Validate Commodity code of customer displaying as per data present under EFD device for that particular month.
    ...
    Examples: 
      | TestcaseID           | Description                           | Period    | Data              | code          | code1         | code2         |
      | Assessed_List_Sales_Domestic_Export_40 | Validating Commodity code of customer | PeriodJan | 20180705073851634 | 6802-KEYBOARD | 6802-KEYBOARD | 6802-KEYBOARD |
  ...
  Scenario Outline: Validate Quantity and its units are  displaying as per data present under EFD device for that particular month.
    ...
    Examples: 
      | TestcaseID           | Description                    | Period    | Data              | quantity       | unit           | invoice     |
      | Assessed_List_Sales_Domestic_Export_41 | Validating Quantity and  units | PeriodJan | 20180705073851634 | lbl_quantity11 | lbl_unitPieces | lbl_invoice |
  ...
  Scenario Outline: Validate Cancelled Invoice numbers is not getting populated on Export Sales page.
    ...
    Examples: 
      | TestcaseID           | Description        | Period    | Data              | quantity       | unit           | invoice     |
      | Assessed_List_Sales_Domestic_Export_42 | Validating invoice | PeriodJan | 20180705073851634 | lbl_quantity11 | lbl_unitPieces | lbl_invoice |
