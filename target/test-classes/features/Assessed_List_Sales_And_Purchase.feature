...
Feature: ManualAssessment and ReAssessment Sales and Purchase (Re-Assessment sales and purchase)

  # this is for re-assement e-declaration page
  @TC_001
  ...
  Scenario Outline: To validate the UI of Manual Assesment Page with sales and purchase section
    ...
    Examples: 
      ...
      | Assessed_List_Sales_and_Purchase_01 | Validating UI for sales and purchase | PeriodJan | Pending |

  @TC_02
  Scenario Outline: To validate the UI of Domestic Sales page when DGI officer clicks on view icon of domestic in transaction received section of sales in e-declaration table on the Assessed List Page
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    Examples: 
      | TestcaseID                          | Description                                 | Period    | Data     |
      | Assessed_List_Sales_and_Purchase_02 | Validating UI for Domestic in sales section | PeriodJan | Assessed |

  @TC_03
  Scenario Outline: To validate the UI of Export Sales page when DGI officer clicks on view icon of export in transaction received section of sales in e-declaration table on the Assessed List Page
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    Examples: 
      | TestcaseID                          | Description                               | Period    | Data     |
      | Assessed_List_Sales_and_Purchase_03 | Validating UI for Export in sales section | PeriodJan | Assessed |
  ...
  Scenario Outline: To validate the UI of Sales Adjustment page when DGI officer clicks on view icon of adjusment in transaction received section of sales in e-declaration table on the Manual Assessment Page
    ...
    Examples: 
      | TestcaseID                          | Description                                    | Period    | Data     |
      | Assessed_List_Sales_and_Purchase_04 | Validating UI for Adjustement in sales section | PeriodJan | Assessed |

  @TC_05
  Scenario Outline: To validate the UI of Domestic Purchase page when DGI officer clicks on view icon of domestic in transaction received section of Purchase in e-declaration table on the Assessed List Page
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    Examples: 
      | TestcaseID                          | Description                                    | Period    | Data     |
      | Assessed_List_Sales_and_Purchase_05 | Validating UI for Domestic in purchase section | PeriodJan | Assessed |

  @TC_06
  Scenario Outline: To validate the UI of Import Purchase page when DGI officer clicks on view icon of export in transaction received section of Purchase in e-declaration table on the Assessed List Page
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    Examples: 
      | TestcaseID                          | Description                                  | Period    | Data     |
      | Assessed_List_Sales_and_Purchase_06 | Validating UI for Export in purchase section | PeriodJan | Assessed |

  @TC_07
  Scenario Outline: To validate the UI of  Purchase Adjustment page when DGI officer clicks on view icon of adjusment in transaction received section of purchase in e-declaration table on the Assessed List Page
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    Examples: 
      | TestcaseID                          | Description                                     | Period    | Data     |
      | Assessed_List_Sales_and_Purchase_07 | Validating UI for Adjusment in purchase section | PeriodJan | Assessed |

  @TC_08
  Scenario Outline: Validate weather the DGI officer is navigated to Liability Calculation page by clicking on next button on the assessed list page
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    Examples: 
      | TestcaseID                          | Description                                    | Period    | Data     |
      | Assessed_List_Sales_and_Purchase_08 | Validating navigation on Liability Calculation | PeriodJan | Assessed |

  @TC_09
  Scenario Outline: Validate weather the DGI officer is navigated to Assessed List Landing Page/Dashboard Page of Assesment module by clicking on Previous button
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    And User click on type here
    And User check its status has been changed "<status>" for Reassess

    Examples: 
      | TestcaseID                          | Description                                           | Period    | Data              | value             | status      |
      | Assessed_List_Sales_and_Purchase_09 | Validating status changed from pending to in progress | PeriodJan | 20180821035120132 | 20180821035120132 | in progress |

  @TC_10
  Scenario Outline: Validate the tax payers NITVA number displaying on the top of Assessed List page with e-declaration table
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    And User click on type here
    And User click on manage setting drop down and click on Reassess
    And User validate nitva number "<nitva>" on top of the Assessed list page

    Examples: 
      | TestcaseID                          | Description                                    | Period    | Data   | nitva             |
      | Assessed_List_Sales_and_Purchase_10 | Validating navigation on Liability Calculation | PeriodJan | franky | 20180821035120132 |

  @TC_11
  Scenario Outline: Validate the Period field displaying on the top of Assessed List Page with e-declaration table
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    Examples: 
      | TestcaseID                          | Description              | Period    | Data   |
      | Assessed_List_Sales_and_Purchase_11 | Validating period  field | PeriodJan | franky |

  #@TC_12  Not yet implemented on hold
  #Scenario Outline: Validate the "?" (help) icon displayed on the top right cornor of the Assessed List page with e-declaration table
  ...
  #And User click on type here
  #And User click on manage setting drop down and click on Reassess
  #And User clik on help icon on the top right cornor of the Assessed list page
  #  Examples:
  #    | TestcaseID                    | Description                                    | Period    | Data    |
  #    | Assessed_List_Sales_and_Purchase_12 | Validating navigation on Liability Calculation | PeriodJan | franky  |
  ...
  Scenario Outline: Validate the download functionality of Transaction Received button
    ...
    Examples: 
      | TestcaseID                          | Description                                                | Period    | Data   |
      | Assessed_List_Sales_and_Purchase_13 | Validating download functionality for transaction received | PeriodJan | franky |
  ...
  Scenario Outline: Validate the download functionality of e-filing schedule button when e-file schedule file is uploaded by tax payer from tax payer portal
    ...
    Examples: 
      | TestcaseID                          | Description                                           | Period    | Data   |
      | Assessed_List_Sales_and_Purchase_14 | Validating download for e-file schedule when uploaded | PeriodJan | franky |
  ...
  Scenario Outline: Validate the download functionality of e-filing schedule button when e-file schedule file is not uploaded by tax payer from tax payer portal
    ...
    Examples: 
      | TestcaseID                          | Description                                             | Period    | Data   |
      | Assessed_List_Sales_and_Purchase_15 | Validating download for e-file schedule is not uploaded | PeriodJan | franky |

  @TC_16
  Scenario Outline: To validate the view icon functionality in transaction received section of Sales in e-declaration table on the Assessed List Page
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    Examples: 
      | TestcaseID                          | Description                                         | Period    | Data   |
      | Assessed_List_Sales_and_Purchase_16 | Validating view icon transaction received for sales | PeriodJan | franky |

  @TC_17
  Scenario Outline: To validate the view icon functionality in transaction received section of Purchase in e-declaration table on the Assessed List Page
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    Examples: 
      | TestcaseID                          | Description                                            | Period    | Data   |
      | Assessed_List_Sales_and_Purchase_17 | Validating view icon transaction received for purchase | PeriodJan | franky |

  @TC_18
  Scenario Outline: Validate the entries displayed in table of Sales on Assessed List page Domestic,Export,Adjustment
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    Examples: 
      ...
      | Assessed_List_Sales_and_Purchase_18 | Validating view icon transaction received for purchase | PeriodJan | franky |                   |                 |                      |                 |               |                    |                 |               |                    |                     |                   |                        |                   |                 |                      |                   |                 |                      |

  @TC_19
  Scenario Outline: Validate the entries displayed in table of Purchase on Assessed List page Domestic,Import and Adjustment
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    Examples: 
      ...
      | Assessed_List_Sales_and_Purchase_19 | Validating view icon transaction received for purchase | PeriodJan | franky |                       |                     |                          |                     |                   |                        |                     |                   |                        |                         |                       |                            |                       |                     |                          |                       |                     |                          |

  @TC_20
  Scenario Outline: Validate the difference values of all columns of sales table on Asssessed List page
    Given User is on Assessment Page "<TestcaseID>" "<Description>"
    And User click on Assessment Tab
    And User click on Assessed List Tab
    And User click on drop down "<Period>"
    ...
    Examples: 
      | TestcaseID                          | Description                                            | Period    | Data   |
      | Assessed_List_Sales_and_Purchase_20 | Validating view icon transaction received for purchase | PeriodJan | franky |
  ...
  Scenario Outline: Validate the difference values of all columns of Purchase table on manual assessment page
    ...
    Examples: 
      | TestcaseID                          | Description                                            | Period    | Data   |
      | Assessed_List_Sales_and_Purchase_21 | Validating view icon transaction received for purchase | PeriodJan | franky |
